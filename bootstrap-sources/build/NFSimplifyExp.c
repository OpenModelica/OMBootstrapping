...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT26,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(114)),_OMC_LIT9,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT23,_OMC_LIT24,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT25}};
...
#define _OMC_LIT38_data "//OpenModelica/OMCompiler/Compiler/NFFrontEnd/NFSimplifyExp.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT38,85,_OMC_LIT38_data);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT44_6,1.784622031e9);
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT49,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(170)),_OMC_LIT47,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT48}};
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT53_6,1.784622031e9);
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT60,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(168)),_OMC_LIT58,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT59}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT80,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(50)),_OMC_LIT62,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT63,_OMC_LIT65,_OMC_LIT78,_OMC_LIT79}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT96,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(140)),_OMC_LIT94,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT63,_OMC_LIT24,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT95}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT119,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(176)),_OMC_LIT117,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT118}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT122,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(169)),_OMC_LIT120,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT121}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT130,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(187)),_OMC_LIT128,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT129}};
            ...
            else
            {
              ...
              tmpMeta28 = stringAppend(tmpMeta27,_OMC_LIT41);
              {
                ...
                while(1) {
                  ...
                  if (tmp32 == 0) {
                    __omcQ_24tmpVar26 = omc_NFExpression_toString(threadData, _e);
        ...
        case 1: {
          ...
          if(omc_List_all(threadData, _dims, (modelica_fnptr) mmc_mk_box2(0,closure7_NFDimension_isKnown,tmpMeta12)))
          {
            ...
            tmpMeta14 = mmc_mk_box3(10, &NFType_ARRAY__desc, _OMC_LIT55, tmpMeta13);
            {
              ...
              __omcQ_24tmpVar31 = tmpMeta17; /* defaultValue */
              ...
              while(1) {
                ...
                if (tmp18 == 0) {
                  __omcQ_24tmpVar30 = omc_NFDimension_sizeExp(threadData, _d);
                  *tmp16 = mmc_mk_cons(__omcQ_24tmpVar30,0);
                  tmp16 = &MMC_CDR(*tmp16);
                } else if (tmp18 == 1) {
                  break;
                } else {
      ...
      for (; tmp6 < 5; tmp6++) {
        ...
        case 0: {
          ...
          {
            {
              ...
              while(1) {
                ...
                if (tmp12 == 0) {
                  __omcQ_24tmpVar38 = (omc_NFExpression_hasArrayCall(threadData, _arg)?_arg:omc_NFExpandExp_expand(threadData, _arg, 0 /* false */, 0 /* false */, NULL));
...

          {
            ...
            __omcQ_24tmpVar41 = tmpMeta15; /* defaultValue */
            ...
            while(1) {
              ...
              if (tmp16 == 0) {
                __omcQ_24tmpVar40 = omc_NFSimplifyExp_simplify(threadData, _arg, 0 /* false */);
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            __omcQ_24tmpVar43 = tmpMeta27; /* defaultValue */
            tmp26 = &__omcQ_24tmpVar43;
            while(1) {
              tmp28 = 1;
              if (!listEmpty(_arg_loopVar)) {
                _arg = MMC_CAR(_arg_loopVar);
              ...
              if (tmp28 == 0) {
                ...
                *tmp26 = mmc_mk_cons(__omcQ_24tmpVar42,0);
                tmp26 = &MMC_CDR(*tmp26);
              } else if (tmp28 == 1) {
                break;
              } else {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            while(1) {
              ...
              if (tmp14 == 0) {
                __omcQ_24tmpVar44 = omc_NFSimplifyExp_simplify(threadData, _e, 0 /* false */);
