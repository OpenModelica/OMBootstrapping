...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT37,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),_OMC_LIT34,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT36}};
    ...
    tmp4_1 = _inState;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          _st = tmp4_1;
          /* Pattern matching succeeded */
          _str1 = omc_AbsynUtil_pathString(threadData, omc_ClassInf_getStateName(threadData, _st), _OMC_LIT22, 1 /* true */, 0 /* false */);
