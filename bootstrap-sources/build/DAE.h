...
#define boxptr_DAE_AvlTreePathFunction_smallestKey omc_DAE_AvlTreePathFunction_smallestKey
static const MMC_DEFSTRUCTLIT(boxvar_lit_DAE_AvlTreePathFunction_smallestKey,2,0) {(void*) boxptr_DAE_AvlTreePathFunction_smallestKey,0}};
#define boxvar_DAE_AvlTreePathFunction_smallestKey MMC_REFSTRUCTLIT(boxvar_lit_DAE_AvlTreePathFunction_smallestKey)
