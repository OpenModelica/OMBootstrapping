...
#define boxptr_TplParser_CacheTree_smallestKey omc_TplParser_CacheTree_smallestKey
static const MMC_DEFSTRUCTLIT(boxvar_lit_TplParser_CacheTree_smallestKey,2,0) {(void*) boxptr_TplParser_CacheTree_smallestKey,0}};
#define boxvar_TplParser_CacheTree_smallestKey MMC_REFSTRUCTLIT(boxvar_lit_TplParser_CacheTree_smallestKey)
