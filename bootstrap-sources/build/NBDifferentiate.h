...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_expressionHasIteratorCref_foldIter,2,0) {(void*) boxptr_NBDifferentiate_expressionHasIteratorCref_foldIter,0}};
#define boxvar_NBDifferentiate_expressionHasIteratorCref_foldIter MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_expressionHasIteratorCref_foldIter)
...
#define boxptr_NBDifferentiate_reverseEquationIterator omc_NBDifferentiate_reverseEquationIterator
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_reverseEquationIterator,2,0) {(void*) boxptr_NBDifferentiate_reverseEquationIterator,0}};
#define boxvar_NBDifferentiate_reverseEquationIterator MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_reverseEquationIterator)


DLLModelDirection
modelica_metatype omc_NBDifferentiate_reverseForRange(threadData_t *threadData, modelica_metatype _rangeIn);
#define boxptr_NBDifferentiate_reverseForRange omc_NBDifferentiate_reverseForRange
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_reverseForRange,2,0) {(void*) boxptr_NBDifferentiate_reverseForRange,0}};
#define boxvar_NBDifferentiate_reverseForRange MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_reverseForRange)
...
#define boxptr_NBDifferentiate_makeShapedArray omc_NBDifferentiate_makeShapedArray
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_makeShapedArray,2,0) {(void*) boxptr_NBDifferentiate_makeShapedArray,0}};
#define boxvar_NBDifferentiate_makeShapedArray MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_makeShapedArray)
...
#define boxptr_NBDifferentiate_makeAdjointAccumulationStatements omc_NBDifferentiate_makeAdjointAccumulationStatements
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_makeAdjointAccumulationStatements,2,0) {(void*) boxptr_NBDifferentiate_makeAdjointAccumulationStatements,0}};
#define boxvar_NBDifferentiate_makeAdjointAccumulationStatements MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_makeAdjointAccumulationStatements)
...
#define boxptr_NBDifferentiate_differentiateIfEquationBodyAdjoint omc_NBDifferentiate_differentiateIfEquationBodyAdjoint
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateIfEquationBodyAdjoint,2,0) {(void*) boxptr_NBDifferentiate_differentiateIfEquationBodyAdjoint,0}};
#define boxvar_NBDifferentiate_differentiateIfEquationBodyAdjoint MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateIfEquationBodyAdjoint)
...
#define boxptr_NBDifferentiate_differentiateStatementAdjoint omc_NBDifferentiate_differentiateStatementAdjoint
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateStatementAdjoint,2,0) {(void*) boxptr_NBDifferentiate_differentiateStatementAdjoint,0}};
#define boxvar_NBDifferentiate_differentiateStatementAdjoint MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateStatementAdjoint)
...
#define boxptr_NBDifferentiate_differentiateEquationAdjoint omc_NBDifferentiate_differentiateEquationAdjoint
static const MMC_DEFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateEquationAdjoint,2,0) {(void*) boxptr_NBDifferentiate_differentiateEquationAdjoint,0}};
#define boxvar_NBDifferentiate_differentiateEquationAdjoint MMC_REFSTRUCTLIT(boxvar_lit_NBDifferentiate_differentiateEquationAdjoint)
