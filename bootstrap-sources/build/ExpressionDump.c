...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT129,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(73)),_OMC_LIT124,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT125,_OMC_LIT126,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT128}};
    ...
    tmp4_1 = _dim;
    {
      ...
      // _e has no default value.
      {
        ...
        case 5: {
          ...
          _p = tmpMeta5;
          /* Pattern matching succeeded */
          tmp1 = omc_AbsynUtil_pathString(threadData, _p, _OMC_LIT15, 1 /* true */, 0 /* false */);
          goto tmp3_done;
        }
        case 4: {
    ...
    tmp4_2 = _inInteger;
    {
      ...
      for (; tmp4 < 32; tmp4++) {
        ...
        case 6: {
          ...
          _s = omc_AbsynUtil_pathString(threadData, _fcn, _OMC_LIT15, 1 /* true */, 0 /* false */);
        ...
        case 14: {
          ...
          _fs = omc_AbsynUtil_pathString(threadData, _fcn, _OMC_LIT15, 1 /* true */, 0 /* false */);
        ...
        case 22: {
          ...
          _e = tmpMeta80;
          _i = tmp85  /* pattern as ty=Integer */;
          _level = tmp4_2;
          /* Pattern matching succeeded */
          _gen_str = omc_ExpressionDump_genStringNTime(threadData, _OMC_LIT20, _level);
        ...
        case 28: {
          ...
          _e = tmpMeta107;
          _i = tmp109  /* pattern as ty=Integer */;
          _fs = tmpMeta110;
          _tp = tmpMeta111;
          _level = tmp4_2;
          tmp4 += 2; /* Pattern matching succeeded; we may skip some cases if we fail */
    ...
    tmp4_1 = _inExp;
    {
      ...
      for (; tmp4 < 24; tmp4++) {
        ...
        case 19: {
          ...
          _e = tmpMeta113;
          _i = tmp118  /* pattern as ty=Integer */;
          tmp4 += 3; /* Pattern matching succeeded; we may skip some cases if we fail */
          _ct = omc_ExpressionDump_dumpExpGraphviz(threadData, _e);
    ...
    tmp4_3 = _opcallfunc;
    {
      ...
      for (; tmp4 < 40; tmp4++) {
        ...
        case 7: {
          ...
          tmp1 = omc_AbsynUtil_pathString(threadData, _lit, _OMC_LIT15, 1 /* true */, 0 /* false */);
          goto tmp3_done;
        }
        case 8: {
          modelica_metatype tmpMeta29;
        ...
        case 15: {
          ...
          _args = tmpMeta53;
          tmp4 += 23; /* Pattern matching succeeded; we may skip some cases if we fail */
          _fs = omc_AbsynUtil_pathString(threadData, omc_AbsynUtil_makeNotFullyQualified(threadData, _fcn), _OMC_LIT15, 1 /* true */, 0 /* false */);
        ...
        case 26: {
          ...
          _riters = tmpMeta91;
          tmp4 += 12; /* Pattern matching succeeded; we may skip some cases if we fail */
          _fs = omc_AbsynUtil_pathStringNoQual(threadData, _fcn, _OMC_LIT15, 0 /* false */, 0 /* false */);
    ...
    tmp4_1 = _subscript;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          _enum_lit = tmpMeta10;
          /* Pattern matching succeeded */
          tmp1 = omc_AbsynUtil_pathString(threadData, _enum_lit, _OMC_LIT15, 1 /* true */, 0 /* false */);
          goto tmp3_done;
        }
        }
        goto tmp3_end;
