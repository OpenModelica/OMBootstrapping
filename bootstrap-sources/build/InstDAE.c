...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT15,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(111)),_OMC_LIT12,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT14}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT34,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),_OMC_LIT31,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT33}};
    ...
    tmp4_13 = _declareComplexVars;
    {
      ...
      for (; tmp4 < 16; tmp4++) {
        ...
        case 6: {
          ...
          _finst_dims = omc_List_flatten(threadData, _inst_dims);
          tmpMeta24 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _vn, _kind, _dir, _daePrl, _prot, _ty, _e, _finst_dims, _ct, _source, _dae_var_attr, _comment, _io, mmc_mk_boolean(0 /* false */));
        ...
        case 7: {
          ...
          _finst_dims = omc_List_flatten(threadData, _inst_dims);
          tmpMeta28 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _vn, _kind, _dir, _daePrl, _prot, _ty, _e, _finst_dims, _ct, _source, _dae_var_attr, _comment, _io, mmc_mk_boolean(0 /* false */));
        ...
        case 12: {
          ...
          _finst_dims = omc_List_flatten(threadData, _inst_dims);
          tmpMeta45 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _vn, _kind, _dir, _daePrl, _prot, _ty, _e, _finst_dims, _ct, _source, _dae_var_attr, _comment, _io, mmc_mk_boolean(0 /* false */));
        ...
        case 13: {
          ...
          _tty = tmpMeta47;
          tmpMeta49 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _vn, _kind, _dir, _daePrl, _prot, _tty, _e, _finst_dims, _ct, _source, _dae_var_attr, _comment, _io, mmc_mk_boolean(0 /* false */));
        ...
        case 14: {
          ...
          _finst_dims = omc_List_flatten(threadData, _inst_dims);
          tmpMeta54 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _vn, _kind, _dir, _daePrl, _prot, _ty, _e, _finst_dims, _ct, _source, _dae_var_attr, _comment, _io, mmc_mk_boolean(0 /* false */));
  ...
  { /* matchcontinue expression */
    {
      ...
      for (; tmp3 < 4; tmp3++) {
        ...
        case 1: {
          ...
          tmpMeta8 = mmc_mk_box5(21, &DAE_Element_COMP__desc, _sstr, _els, _OMC_LIT21, mmc_mk_none());
          _comp = tmpMeta8;
