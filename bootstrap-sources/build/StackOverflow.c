...
PROTECTED_FUNCTION_STATIC modelica_string omc_StackOverflow_stripAddresses(threadData_t *threadData, modelica_string _inSymbol)
{
  ...
  _n = omc_System_regex(threadData, _inSymbol, _OMC_LIT7, ((modelica_integer) 3), 1 /* true */, 0 /* false */ ,&_strs);
  ...
  {
    _n = omc_System_regex(threadData, _inSymbol, _OMC_LIT8, ((modelica_integer) 3), 1 /* true */, 0 /* false */ ,&_strs);
