    ...
    tmp4_1 = _outTree;
    {
      ...
      // _new_right has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _new_left = omc_DAE_AvlTreePathFunction_map(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outTree), 5))), ((modelica_fnptr) _inFunc));
          ...
          _new_right = omc_DAE_AvlTreePathFunction_map(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outTree), 6))), ((modelica_fnptr) _inFunc));
          ...
          {
            tmpMeta7 = mmc_mk_box6(3, &DAE_AvlTreePathFunction_Tree_NODE__desc, _key, _new_value, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outTree), 4))), _new_left, _new_right);
            _outTree = tmpMeta7;
          }
          tmpMeta1 = _outTree;
          goto tmp3_done;
    ...
    tmp4_1 = _outTree;
    {
      ...
      // _new_right has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _new_left = omc_DAE_AvlTreePathFunction_mapFold(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outTree), 5))), ((modelica_fnptr) _inFunc), _outResult ,&_outResult);
          ...
          _new_right = omc_DAE_AvlTreePathFunction_mapFold(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_outTree), 6))), ((modelica_fnptr) _inFunc), _outResult ,&_outResult);
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          _right = tmpMeta6;
          /* Pattern matching succeeded */
          tmpMeta7 = stringAppend(omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, _left, 1 /* true */, _OMC_LIT6),omc_DAE_AvlTreePathFunction_printNodeStr(threadData, _inTree));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT7);
          tmpMeta9 = stringAppend(tmpMeta8,omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, _right, 0 /* false */, _OMC_LIT6));
          tmp1 = tmpMeta9;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          tmpMeta6 = stringAppend(omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 5))), 1 /* true */, tmpMeta5),_inIndent);
          tmpMeta7 = stringAppend(tmpMeta6,(_isLeft?_OMC_LIT10:_OMC_LIT11));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT12);
          tmpMeta9 = stringAppend(tmpMeta8,omc_DAE_AvlTreePathFunction_printNodeStr(threadData, _inTree));
          tmpMeta10 = stringAppend(tmpMeta9,_OMC_LIT7);
          tmpMeta11 = stringAppend(_inIndent,(_isLeft?_OMC_LIT9:_OMC_LIT8));
          tmpMeta12 = stringAppend(tmpMeta10,omc_DAE_AvlTreePathFunction_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 6))), 0 /* false */, tmpMeta11));
          tmp1 = tmpMeta12;
          goto tmp3_done;
        }
        case 4: {
          ...
          tmpMeta15 = stringAppend(tmpMeta14,omc_DAE_AvlTreePathFunction_printNodeStr(threadData, _inTree));
...
DLLDirection
modelica_metatype omc_DAE_AvlTreePathFunction_smallestKey(threadData_t *threadData, modelica_metatype _tree)
{
  modelica_metatype _key = NULL;
  modelica_metatype tmpMeta1;
  MMC_SO();
