...
#define _OMC_LIT2_data "//OpenModelica/OMCompiler/Compiler/FrontEnd/DAEUtil.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT2,77,_OMC_LIT2_data);
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT24,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(159)),_OMC_LIT22,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT23}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT57,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(100)),_OMC_LIT55,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT56}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT60,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(66)),_OMC_LIT58,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT59}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT72,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(93)),_OMC_LIT70,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT71}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT75,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(122)),_OMC_LIT73,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT74}};
        ...
        case 1: {
...

          {
            ...
            while(1) {
              ...
              if (tmp10 == 0) {
                __omcQ_24tmpVar4 = omc_AbsynUtil_pathString(threadData, _p, _OMC_LIT47, 1 /* true */, 0 /* false */);
      ...
      for (; tmp4 < 14; tmp4++) {
        ...
        case 11: {
...

          {
            ...
            _sub_loopVar = _subs;
            tmpMeta51 = MMC_REFSTRUCTLIT(mmc_nil);
            __omcQ_24tmpVar7 = tmpMeta51; /* defaultValue */
            tmp50 = &__omcQ_24tmpVar7;
            while(1) {
              tmp52 = 1;
              ...
              if (tmp52 == 0) {
                __omcQ_24tmpVar6 = omc_Expression_getSubscriptExp(threadData, _sub);
                *tmp50 = mmc_mk_cons(__omcQ_24tmpVar6,0);
                tmp50 = &MMC_CDR(*tmp50);
              } else if (tmp52 == 1) {
                break;
              } else {
