...
#define boxptr_Util_optionToString omc_Util_optionToString
static const MMC_DEFSTRUCTLIT(boxvar_lit_Util_optionToString,2,0) {(void*) boxptr_Util_optionToString,0}};
#define boxvar_Util_optionToString MMC_REFSTRUCTLIT(boxvar_lit_Util_optionToString)
