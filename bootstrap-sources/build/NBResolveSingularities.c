...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT24,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(85)),_OMC_LIT22,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT23}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT38,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(50)),_OMC_LIT36,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT37}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT54,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(51)),_OMC_LIT52,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT53}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT80,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(69)),_OMC_LIT78,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT79}};
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            while(1) {
              ...
              if (tmp10 == 0) {
                __omcQ_24tmpVar18 = omc_NBResolveSingularities_removeSlicedDerivateEqn(threadData, _b, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_eqn), 3))), _dummy_slice_set, _aux_index);
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            while(1) {
              ...
              if (tmp16 == 0) {
                __omcQ_24tmpVar20 = omc_NBResolveSingularities_removeSlicedDerivateEqn_replaceTupleLiterals(threadData, _e, _iter, _dummy_slice_set, _aux_index);
  ...
  {
    {
      ...
      __omcQ_24tmpVar23 = tmpMeta5; /* defaultValue */
      tmp4 = &__omcQ_24tmpVar23;
      while(1) {
        tmp6 = 1;
        ...
        if (tmp6 == 0) {
          __omcQ_24tmpVar22 = _ind;
          *tmp4 = mmc_mk_cons(__omcQ_24tmpVar22,0);
          tmp4 = &MMC_CDR(*tmp4);
        } else if (tmp6 == 1) {
          break;
        } else {
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NBResolveSingularities_getMSSS(threadData_t *threadData, modelica_metatype _m, modelica_metatype _mT, modelica_metatype _matching, modelica_metatype _excluded_eqns, modelica_metatype _mapping)
{
...

  {
    ...
    while(1) {
      ...
      if (tmp9 == 0) {
        __omcQ_24tmpVar24 = mmc_mk_integer(_i);
    ...
    if((!listEmpty(_unmatched_eqns)))
    {
...

      {
        ...
        while(1) {
          ...
          if (tmp10 == 0) {
            __omcQ_24tmpVar28 = omc_NBSlice_getT(threadData, _eqn);
    ...
    if(listEmpty(_failed_vars))
    {
...

      {
        ...
        while(1) {
          ...
          if (tmp17 == 0) {
            __omcQ_24tmpVar30 = omc_NBEquation_Equation_getEqnName(threadData, _eqn);
...
modelica_metatype omc_NBResolveSingularities_indexReduction(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fadj, modelica_metatype __omcQ_24in_5Ffull, modelica_metatype __omcQ_24in_5Fvariables, modelica_metatype __omcQ_24in_5Fequations, modelica_metatype __omcQ_24in_5FvarData, modelica_metatype __omcQ_24in_5FeqData, modelica_integer _kind, modelica_metatype _funcMap, modelica_metatype _matching, modelica_metatype _mapping_opt, modelica_metatype *out_full, modelica_metatype *out_variables, modelica_metatype *out_equations, modelica_metatype *out_varData, modelica_metatype *out_eqData, modelica_boolean *out_changed)
{
...

  {
    ...
    while(1) {
      ...
      if (tmp13 == 0) {
        __omcQ_24tmpVar32 = mmc_mk_boolean((omc_NBEquation_Equation_isDiscrete(threadData, _eqn) || omc_NBEquation_Equation_hasDerivative(threadData, _eqn)));
  ...
  if((!(arrayLength(_msss) == ((modelica_integer) 0))))
  {
...

    {
      ...
      __omcQ_24tmpVar35 = ((modelica_integer) 0); /* defaultValue */
      while(1) {
        tmp25 = 1;
        ...
        if (tmp25 == 0) {
          ...
          __omcQ_24tmpVar34 = omc_NBSlice_size(threadData, _eq, (modelica_fnptr) mmc_mk_box2(0,closure6_NBEquation_Equation_size,tmpMeta24));
      ...
      for (tmpMeta46 = _stages; !listEmpty(tmpMeta46); tmpMeta46=MMC_CDR(tmpMeta46))
      {
        ...
        else
        {
...

          {
            ...
            __omcQ_24tmpVar37 = tmpMeta55; /* defaultValue */
            ...
            while(1) {
              ...
              if (tmp56 == 0) {
                __omcQ_24tmpVar36 = omc_NBVariable_getVarName(threadData, _var);
                *tmp54 = mmc_mk_cons(__omcQ_24tmpVar36,0);
                tmp54 = &MMC_CDR(*tmp54);
              } else if (tmp56 == 1) {
                break;
              } else {
...

    {
      ...
      __omcQ_24tmpVar39 = tmpMeta92; /* defaultValue */
      tmp91 = &__omcQ_24tmpVar39;
      while(1) {
        tmp93 = 1;
        ...
        if (tmp93 == 0) {
          ...
          *tmp91 = mmc_mk_cons(__omcQ_24tmpVar38,0);
          tmp91 = &MMC_CDR(*tmp91);
        } else if (tmp93 == 1) {
          break;
        } else {
...

    {
      ...
      __omcQ_24tmpVar41 = tmpMeta96; /* defaultValue */
      tmp95 = &__omcQ_24tmpVar41;
      while(1) {
        tmp97 = 1;
        if (!listEmpty(_slice_loopVar)) {
          _slice = MMC_CAR(_slice_loopVar);
        ...
        if (tmp97 == 0) {
          ...
          *tmp95 = mmc_mk_cons(__omcQ_24tmpVar40,0);
          tmp95 = &MMC_CDR(*tmp95);
        } else if (tmp97 == 1) {
          break;
        } else {
...

    {
      ...
      __omcQ_24tmpVar43 = tmpMeta100; /* defaultValue */
      tmp99 = &__omcQ_24tmpVar43;
      while(1) {
        tmp101 = 1;
        ...
        if (tmp101 == 0) {
          __omcQ_24tmpVar42 = omc_NBVariable_getVarPointer(threadData, _cref, _OMC_LIT84);
          *tmp99 = mmc_mk_cons(__omcQ_24tmpVar42,0);
          tmp99 = &MMC_CDR(*tmp99);
        } else if (tmp101 == 1) {
          break;
        } else {
