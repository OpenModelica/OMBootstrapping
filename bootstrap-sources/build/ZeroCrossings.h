...
static const MMC_DEFSTRUCTLIT(boxvar_lit_ZeroCrossings_count,2,0) {(void*) boxptr_ZeroCrossings_count,0}};
#define boxvar_ZeroCrossings_count MMC_REFSTRUCTLIT(boxvar_lit_ZeroCrossings_count)


DLLModelDirection
void omc_ZeroCrossings_push__list(threadData_t *threadData, modelica_metatype _zc_set, modelica_metatype _zc_lst);
#define boxptr_ZeroCrossings_push__list omc_ZeroCrossings_push__list
static const MMC_DEFSTRUCTLIT(boxvar_lit_ZeroCrossings_push__list,2,0) {(void*) boxptr_ZeroCrossings_push__list,0}};
#define boxvar_ZeroCrossings_push__list MMC_REFSTRUCTLIT(boxvar_lit_ZeroCrossings_push__list)


DLLModelDirection
void omc_ZeroCrossings_push(threadData_t *threadData, modelica_metatype _zc_set, modelica_metatype _zc);
#define boxptr_ZeroCrossings_push omc_ZeroCrossings_push
static const MMC_DEFSTRUCTLIT(boxvar_lit_ZeroCrossings_push,2,0) {(void*) boxptr_ZeroCrossings_push,0}};
#define boxvar_ZeroCrossings_push MMC_REFSTRUCTLIT(boxvar_lit_ZeroCrossings_push)
...
#define boxptr_ZeroCrossings_ZeroCrossingTree_addUpdate omc_ZeroCrossings_ZeroCrossingTree_addUpdate
static const MMC_DEFSTRUCTLIT(boxvar_lit_ZeroCrossings_ZeroCrossingTree_addUpdate,2,0) {(void*) boxptr_ZeroCrossings_ZeroCrossingTree_addUpdate,0}};
#define boxvar_ZeroCrossings_ZeroCrossingTree_addUpdate MMC_REFSTRUCTLIT(boxvar_lit_ZeroCrossings_ZeroCrossingTree_addUpdate)
