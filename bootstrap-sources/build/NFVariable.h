...
DLLModelDirection
modelica_boolean omc_NFVariable_isFixed(threadData_t *threadData, modelica_metatype _var);
DLLModelDirection
modelica_metatype boxptr_NFVariable_isFixed(threadData_t *threadData, modelica_metatype _var);
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFVariable_isFixed,2,0) {(void*) boxptr_NFVariable_isFixed,0}};
#define boxvar_NFVariable_isFixed MMC_REFSTRUCTLIT(boxvar_lit_NFVariable_isFixed)
