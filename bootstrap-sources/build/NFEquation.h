...
#define boxptr_NFEquation_scopeCell omc_NFEquation_scopeCell
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFEquation_scopeCell,2,0) {(void*) boxptr_NFEquation_scopeCell,0}};
#define boxvar_NFEquation_scopeCell MMC_REFSTRUCTLIT(boxvar_lit_NFEquation_scopeCell)
