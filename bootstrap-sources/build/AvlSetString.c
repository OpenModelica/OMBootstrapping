    ...
    tmp4_1 = _tree;
    {
      ...
      // _outTree has no default value.
      {
        ...
        case 5: {
          ...
          tmpMeta5 = omc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
          tmpMeta1 = tmpMeta5;
          goto tmp3_done;
        }
        case 3: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            ...
            ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta7))[4] = omc_AvlSetString_add(threadData, (OMC_BOX_FIELD(_tree, 4)), _inKey);
            _tree = tmpMeta7;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              ...
              ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta8))[5] = omc_AvlSetString_add(threadData, (OMC_BOX_FIELD(_tree, 5)), _inKey);
              _tree = tmpMeta8;
            }
          }
        ...
        case 4: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            tmpMeta10 = omc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
            tmpMeta11 = omc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), omc_mk_integer(((modelica_integer) 2)), tmpMeta10, _OMC_LIT0);
            _outTree = tmpMeta11;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              tmpMeta12 = omc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, _inKey);
              tmpMeta13 = omc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), omc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta12);
              _outTree = tmpMeta13;
            }
            else
            {
    ...
    tmp4_1 = _outTree;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          _lh = omc_AvlSetString_height(threadData, (OMC_BOX_FIELD(_outTree, 4)));

          _rh = omc_AvlSetString_height(threadData, (OMC_BOX_FIELD(_outTree, 5)));

          _diff = _lh - _rh;

          if((_diff < ((modelica_integer) -1)))
          {
            _balanced_tree = ((omc_AvlSetString_calculateBalance(threadData, (OMC_BOX_FIELD(_outTree, 5))) > ((modelica_integer) 0))?omc_AvlSetString_rotateLeft(threadData, omc_AvlSetString_setTreeLeftRight(threadData, _outTree, (OMC_BOX_FIELD(_outTree, 4)), omc_AvlSetString_rotateRight(threadData, (OMC_BOX_FIELD(_outTree, 5))))):omc_AvlSetString_rotateLeft(threadData, _outTree));
          }
          else
          {
            if((_diff > ((modelica_integer) 1)))
            {
              _balanced_tree = ((omc_AvlSetString_calculateBalance(threadData, (OMC_BOX_FIELD(_outTree, 4))) < ((modelica_integer) 0))?omc_AvlSetString_rotateRight(threadData, omc_AvlSetString_setTreeLeftRight(threadData, _outTree, omc_AvlSetString_rotateLeft(threadData, (OMC_BOX_FIELD(_outTree, 4))), (OMC_BOX_FIELD(_outTree, 5)))):omc_AvlSetString_rotateRight(threadData, _outTree));
            }
            else
            {
    ...
    tmp4_1 = _inNode;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_AvlSetString_height(threadData, (OMC_BOX_FIELD(_inNode, 4))) - omc_AvlSetString_height(threadData, (OMC_BOX_FIELD(_inNode, 5)));
          goto tmp3_done;
        }
        case 4: {
    ...
    tmp4_1 = _treeToJoin;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _tree = omc_AvlSetString_add(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 2)));

          _tree = omc_AvlSetString_join(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 4)));
          /* Tail recursive call */
        ...
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_AvlSetString_add(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 2)));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _lst = omc_AvlSetString_listKeys(threadData, (OMC_BOX_FIELD(_inTree, 5)), _lst);
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _lst = omc_AvlSetString_listKeysReverse(threadData, (OMC_BOX_FIELD(_inTree, 4)), _lst);
    ...
    tmp4_1 = _inNode;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_AvlSetString_keyStr(threadData, (OMC_BOX_FIELD(_inNode, 2)));
          goto tmp3_done;
        }
        case 1: {
          if (mmc__uniontype__metarecord__typedef__equal(tmp4_1,1,1) == 0) goto tmp3_end;
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          _right = tmpMeta6;
          /* Pattern matching succeeded */
          tmp7 = stringAppend(omc_AvlSetString_printTreeStr2(threadData, _left, 1 /* true */, _OMC_LIT2),omc_AvlSetString_printNodeStr(threadData, _inTree));
          tmp8 = stringAppend(tmp7,_OMC_LIT3);
          tmp9 = stringAppend(tmp8,omc_AvlSetString_printTreeStr2(threadData, _right, 0 /* false */, _OMC_LIT2));
          tmp1 = tmp9;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          tmp6 = stringAppend(omc_AvlSetString_printTreeStr2(threadData, (OMC_BOX_FIELD(_inTree, 4)), 1 /* true */, tmp5),_inIndent);
          tmp7 = stringAppend(tmp6,(_isLeft?_OMC_LIT6:_OMC_LIT7));
          tmp8 = stringAppend(tmp7,_OMC_LIT8);
          tmp9 = stringAppend(tmp8,omc_AvlSetString_printNodeStr(threadData, _inTree));
          tmp10 = stringAppend(tmp9,_OMC_LIT3);
          tmp11 = stringAppend(_inIndent,(_isLeft?_OMC_LIT5:_OMC_LIT4));
          tmp12 = stringAppend(tmp10,omc_AvlSetString_printTreeStr2(threadData, (OMC_BOX_FIELD(_inTree, 5)), 0 /* false */, tmp11));
          tmp1 = tmp12;
          goto tmp3_done;
        }
        case 4: {
          ...
          tmp15 = stringAppend(tmp14,omc_AvlSetString_printNodeStr(threadData, _inTree));
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _child = tmpMeta6;
          /* Pattern matching succeeded */
          _node = omc_AvlSetString_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_outNode, 4)), (OMC_BOX_FIELD(_child, 4)));
          tmpMeta1 = omc_AvlSetString_setTreeLeftRight(threadData, _child, _node, (OMC_BOX_FIELD(_child, 5)));
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
          ...
          _child = tmpMeta7;
          /* Pattern matching succeeded */
          _node = omc_AvlSetString_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_outNode, 4)), _OMC_LIT0);
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _child = tmpMeta6;
          /* Pattern matching succeeded */
          _node = omc_AvlSetString_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_child, 5)), (OMC_BOX_FIELD(_outNode, 5)));
          tmpMeta1 = omc_AvlSetString_setTreeLeftRight(threadData, _child, (OMC_BOX_FIELD(_child, 4)), _node);
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
          ...
          _child = tmpMeta7;
          /* Pattern matching succeeded */
          _node = omc_AvlSetString_setTreeLeftRight(threadData, _outNode, _OMC_LIT0, (OMC_BOX_FIELD(_outNode, 5)));
    ...
    tmp4_3 = _right;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmpMeta6 = omc_mk_box2(4, &AvlSetString_Tree_LEAF__desc, (OMC_BOX_FIELD(_orig, 2)));
          tmpMeta1 = tmpMeta6;
          goto tmp3_done;
        }
        case 1: {
        ...
        case 2: {
          ...
          /* Pattern matching succeeded */
          tmp8 = (modelica_boolean)(omc_AvlSetString_referenceEqOrEmpty(threadData, (OMC_BOX_FIELD(_orig, 4)), _left) && omc_AvlSetString_referenceEqOrEmpty(threadData, (OMC_BOX_FIELD(_orig, 5)), _right));
          if(tmp8)
          {
            tmpMeta9 = _orig;
          }
          ...
          {
            tmpMeta7 = omc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (OMC_BOX_FIELD(_orig, 2)), omc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_AvlSetString_height(threadData, _left)),(modelica_integer)(omc_AvlSetString_height(threadData, _right)))), _left, _right);
            tmpMeta9 = tmpMeta7;
          }
          tmpMeta1 = tmpMeta9;
          goto tmp3_done;
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta10 = omc_mk_box5(3, &AvlSetString_Tree_NODE__desc, (OMC_BOX_FIELD(_orig, 2)), omc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_AvlSetString_height(threadData, _left)),(modelica_integer)(omc_AvlSetString_height(threadData, _right)))), _left, _right);
          tmpMeta1 = tmpMeta10;
          goto tmp3_done;
        }
        }
...
DLLModelDirection
modelica_string omc_AvlSetString_smallestKey(threadData_t *threadData, modelica_metatype _tree)
{
  modelica_string _key = NULL;
  modelica_string tmp1 = 0;
  modelica_string omc_ret_;
