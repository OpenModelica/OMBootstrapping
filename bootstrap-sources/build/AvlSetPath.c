    ...
    tmp4_1 = _tree;
    {
      ...
      // _outTree has no default value.
      {
        ...
        case 5: {
          ...
          tmpMeta5 = mmc_mk_box2(4, &AvlSetPath_Tree_LEAF__desc, _inKey);
          tmpMeta1 = tmpMeta5;
          goto tmp3_done;
        }
        case 3: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            ...
            ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta7))[4] = omc_AvlSetPath_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 4))), _inKey);
            _tree = tmpMeta7;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              ...
              ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta8))[5] = omc_AvlSetPath_add(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 5))), _inKey);
              _tree = tmpMeta8;
            }
          }
        ...
        case 4: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            tmpMeta10 = mmc_mk_box2(4, &AvlSetPath_Tree_LEAF__desc, _inKey);
            tmpMeta11 = mmc_mk_box5(3, &AvlSetPath_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), mmc_mk_integer(((modelica_integer) 2)), tmpMeta10, _OMC_LIT0);
            _outTree = tmpMeta11;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              tmpMeta12 = mmc_mk_box2(4, &AvlSetPath_Tree_LEAF__desc, _inKey);
              tmpMeta13 = mmc_mk_box5(3, &AvlSetPath_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_tree), 2))), mmc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta12);
              _outTree = tmpMeta13;
            }
            else
            {
    ...
    tmp4_1 = _treeToJoin;
    {
      int tmp4;
      {
        ...
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_AvlSetPath_add(threadData, _tree, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_treeToJoin), 2))));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          _right = tmpMeta6;
          /* Pattern matching succeeded */
          tmpMeta7 = stringAppend(omc_AvlSetPath_printTreeStr2(threadData, _left, 1 /* true */, _OMC_LIT3),omc_AvlSetPath_printNodeStr(threadData, _inTree));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT4);
          tmpMeta9 = stringAppend(tmpMeta8,omc_AvlSetPath_printTreeStr2(threadData, _right, 0 /* false */, _OMC_LIT3));
          tmp1 = tmpMeta9;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta5 = stringAppend(_inIndent,(_isLeft?_OMC_LIT5:_OMC_LIT6));
          tmpMeta6 = stringAppend(omc_AvlSetPath_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 4))), 1 /* true */, tmpMeta5),_inIndent);
          tmpMeta7 = stringAppend(tmpMeta6,(_isLeft?_OMC_LIT7:_OMC_LIT8));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT9);
          tmpMeta9 = stringAppend(tmpMeta8,omc_AvlSetPath_printNodeStr(threadData, _inTree));
          tmpMeta10 = stringAppend(tmpMeta9,_OMC_LIT4);
          tmpMeta11 = stringAppend(_inIndent,(_isLeft?_OMC_LIT6:_OMC_LIT5));
          tmpMeta12 = stringAppend(tmpMeta10,omc_AvlSetPath_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 5))), 0 /* false */, tmpMeta11));
          tmp1 = tmpMeta12;
          goto tmp3_done;
        }
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta13 = stringAppend(_inIndent,(_isLeft?_OMC_LIT7:_OMC_LIT8));
          tmpMeta14 = stringAppend(tmpMeta13,_OMC_LIT9);
          tmpMeta15 = stringAppend(tmpMeta14,omc_AvlSetPath_printNodeStr(threadData, _inTree));
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta1 = omc_AvlSetPath_setTreeLeftRight(threadData, _child, _node, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 5))));
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta1 = omc_AvlSetPath_setTreeLeftRight(threadData, _child, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_child), 4))), _node);
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
    ...
    tmp4_3 = _right;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmpMeta6 = mmc_mk_box2(4, &AvlSetPath_Tree_LEAF__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))));
          tmpMeta1 = tmpMeta6;
          goto tmp3_done;
        }
        case 1: {
        ...
        case 2: {
          ...
          /* Pattern matching succeeded */
          tmp8 = (modelica_boolean)(omc_AvlSetPath_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 4))), _left) && omc_AvlSetPath_referenceEqOrEmpty(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 5))), _right));
          if(tmp8)
          {
            tmpMeta9 = _orig;
          }
          ...
          {
            tmpMeta7 = mmc_mk_box5(3, &AvlSetPath_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))), mmc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_AvlSetPath_height(threadData, _left)),(modelica_integer)(omc_AvlSetPath_height(threadData, _right)))), _left, _right);
            tmpMeta9 = tmpMeta7;
          }
          tmpMeta1 = tmpMeta9;
          goto tmp3_done;
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta10 = mmc_mk_box5(3, &AvlSetPath_Tree_NODE__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_orig), 2))), mmc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_AvlSetPath_height(threadData, _left)),(modelica_integer)(omc_AvlSetPath_height(threadData, _right)))), _left, _right);
          tmpMeta1 = tmpMeta10;
          goto tmp3_done;
        }
        }
