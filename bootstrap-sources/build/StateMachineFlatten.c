...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT10,8,3) {&DAE_CallAttributes_CALL__ATTR__desc,_OMC_LIT7,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT8,_OMC_LIT9}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT19,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(81)),_OMC_LIT13,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT14,_OMC_LIT16,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT18}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT28,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(86)),_OMC_LIT24,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT14,_OMC_LIT25,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT27}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT80,8,3) {&DAE_CallAttributes_CALL__ATTR__desc,_OMC_LIT52,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT8,_OMC_LIT9}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT84,8,3) {&DAE_CallAttributes_CALL__ATTR__desc,_OMC_LIT52,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT8,_OMC_LIT9}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT101,8,3) {&DAE_CallAttributes_CALL__ATTR__desc,_OMC_LIT91,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT8,_OMC_LIT9}};
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_createVarWithStartValue(threadData_t *threadData, modelica_metatype _componentRef, modelica_metatype _kind, modelica_metatype _ty, modelica_metatype _startExp, modelica_metatype _dims)
{
  ...
  tmpMeta1 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _componentRef, _kind, _OMC_LIT46, _OMC_LIT47, _OMC_LIT48, _ty, mmc_mk_none(), _dims, _OMC_LIT49, _OMC_LIT33, mmc_mk_none(), mmc_mk_none(), _OMC_LIT50, mmc_mk_boolean(0 /* false */));
  _var = tmpMeta1;
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_basicFlatSmSemantics(threadData_t *threadData, modelica_string _ident, modelica_metatype _q, modelica_metatype _inTransitions)
{
...

  {
    ...
    for (tmpMeta125 = _cExps; !listEmpty(tmpMeta125); tmpMeta125=MMC_CDR(tmpMeta125))
    {
      ...
      tmp135 = (modelica_boolean)mmc_unbox_boolean(omc_Util_applyOptionOrDefault(threadData, _bindExp, (modelica_fnptr) mmc_mk_box2(0,closure0_Expression_expEqual,tmpMeta132), mmc_mk_boolean(0 /* false */)));
      if(tmp135)
      {
        tmpMeta136 = _exp;
      }
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_addPropagationEquations(threadData_t *threadData, modelica_metatype _inFlatSmSemantics, modelica_metatype _inEnclosingStateCrefOption, modelica_metatype _inEnclosingFlatSmSemanticsOption)
{
  ...
  // _andExp has no default value.
  // _eqExp has no default value.
  // _activeResetStateRefExp has no default value.
  // _activeStateRefExp has no default value.
  // _activeResetRefExp has no default value.
  // _tArrayBool has no default value.
  // _tArrayInteger has no default value.
    ...
    tmp4_2 = _inCrefsHit;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          /* Check guard condition after assignments */
          if (!omc_List_any(threadData, _crefs, (modelica_fnptr) mmc_mk_box2(0,closure1_ComponentReference_crefEqual,tmpMeta14))) goto tmp3_end;
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_wrapInStateActivationConditionalCT(threadData_t *threadData, modelica_metatype _inEqn, modelica_metatype _inStateCref)
{
  ...
  tmpMeta19 = mmc_mk_box8(3, &DAE_CallAttributes_CALL__ATTR__desc, _ty, mmc_mk_boolean(0 /* false */), mmc_mk_boolean(1 /* true */), mmc_mk_boolean(0 /* false */), mmc_mk_boolean(0 /* false */), _OMC_LIT8, _OMC_LIT9);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_wrapInStateActivationConditional(threadData_t *threadData, modelica_metatype _inEqn, modelica_metatype _inStateCref, modelica_boolean _isResetEquation)
{
  ...
  tmpMeta14 = mmc_mk_box8(3, &DAE_CallAttributes_CALL__ATTR__desc, _ty, mmc_mk_boolean(0 /* false */), mmc_mk_boolean(1 /* true */), mmc_mk_boolean(0 /* false */), mmc_mk_boolean(0 /* false */), _OMC_LIT8, _OMC_LIT9);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_createResetEquation(threadData_t *threadData, modelica_metatype _inLHSCref, modelica_metatype _inLHSty, modelica_metatype _inStateCref, modelica_metatype _inEnclosingFlatSmSemantics, modelica_metatype _crToExpOpt)
{
  ...
  tmpMeta18 = mmc_mk_box8(3, &DAE_CallAttributes_CALL__ATTR__desc, _inLHSty, mmc_mk_boolean(0 /* false */), mmc_mk_boolean(1 /* true */), mmc_mk_boolean(0 /* false */), mmc_mk_boolean(0 /* false */), _OMC_LIT8, _OMC_LIT9);
      ...
      tmp25_1 = _inLHSty;
      {
        int tmp25;
        {
          ...
          case 8: {
            ...
            tmpMeta35 = stringAppend(tmpMeta34,_OMC_LIT116);
          ...
          tmp24_default: OMC_LABEL_UNUSED; {
            ...
            /* Pattern matching succeeded */
            tmpMeta36 = stringAppend(_OMC_LIT113,omc_ComponentReference_crefStr(threadData, _inLHSCref));
            tmpMeta37 = stringAppend(tmpMeta36,_OMC_LIT118);
  ...
  tmpMeta39 = mmc_mk_box3(9, &DAE_Exp_CREF__desc, omc_ComponentReference_appendStringLastIdent(threadData, _OMC_LIT107, _inLHSCref), _inLHSty);
  _lhsExp = tmpMeta39;

  tmpMeta40 = mmc_mk_box4(6, &DAE_Element_EQUATION__desc, _lhsExp, _ifExp, _OMC_LIT33);
  _outEqn = tmpMeta40;
  _return: OMC_LABEL_UNUSED
  return _outEqn;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_createResetEquationCT(threadData_t *threadData, modelica_metatype _inLHSCref, modelica_metatype _inLHSty, modelica_metatype _inStateCref, modelica_metatype _inEnclosingFlatSmSemantics, modelica_metatype _crToExpOpt)
{
      ...
      tmp21_1 = _inLHSty;
      {
        int tmp21;
        {
          ...
          case 8: {
            ...
            /* Pattern matching succeeded */
            tmpMeta30 = stringAppend(_OMC_LIT113,omc_ComponentReference_crefStr(threadData, _inLHSCref));
            tmpMeta31 = stringAppend(tmpMeta30,_OMC_LIT116);
            omc_Error_addCompilerWarning(threadData, tmpMeta31);
          ...
          tmp20_default: OMC_LABEL_UNUSED; {
            ...
            /* Pattern matching succeeded */
            tmpMeta32 = stringAppend(_OMC_LIT113,omc_ComponentReference_crefStr(threadData, _inLHSCref));
            tmpMeta33 = stringAppend(tmpMeta32,_OMC_LIT118);
  ...
  tmpMeta34 = mmc_mk_box4(27, &DAE_Element_REINIT__desc, _inLHSCref, _startValueExp, _OMC_LIT33);
  _reinitElem = tmpMeta34;

  tmpMeta35 = mmc_mk_cons(_reinitElem, MMC_REFSTRUCTLIT(mmc_nil));
  tmpMeta36 = mmc_mk_box5(13, &DAE_Element_WHEN__EQUATION__desc, _andExp, tmpMeta35, mmc_mk_none(), _OMC_LIT33);
  _outEqn = tmpMeta36;
  _return: OMC_LABEL_UNUSED
  return _outEqn;
}
    ...
    tmp4_1 = _eqn;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta12 = mmc_mk_box2(0, _cref, mmc_mk_boolean(0 /* false */));
          ...
          _found = tmp11  /* pattern as ty=Boolean */;
          tmp1 = _found;
          goto tmp3_done;
        }
        case 1: {
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_addStateActivationAndReset1(threadData_t *threadData, modelica_metatype _inEqn, modelica_metatype _inEnclosingSMComp, modelica_metatype _inEnclosingFlatSmSemantics, modelica_metatype _crToExpOpt, modelica_metatype _accEqnsVars)
{
  ...
  // _substituteRef has no default value.
  // _activeResetRef has no default value.
  // _activeResetStatesRef has no default value.
  ...
  { /* matchcontinue expression */
    {
      ...
      for (; tmp10 < 2; tmp10++) {
        ...
        case 0: {
          ...
          if(omc_List_any(threadData, _stateVarCrefs, (modelica_fnptr) mmc_mk_box2(0,closure2_ComponentReference_crefEqual,tmpMeta21)))
          {
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_StateMachineFlatten_elabXInStateOps(threadData_t *threadData, modelica_metatype _inFlatSmSemantics, modelica_metatype _inEnclosingStateCrefOption)
{
  ...
  // _conditionNew has no default value.
...

  {
    ...
    for (tmpMeta17 = omc_List_zip(threadData, _t, _c); !listEmpty(tmpMeta17); tmpMeta17=MMC_CDR(tmpMeta17))
    {
      ...
      /* Pattern-matching tuple assignment */
      tmpMeta42 = mmc_mk_box3(0, _OMC_LIT129, _substTickExp, mmc_mk_boolean(0 /* false */));
      ...
      /* Pattern-matching tuple assignment */
      tmpMeta49 = mmc_mk_box3(0, _OMC_LIT131, _substTimeExp, mmc_mk_boolean(0 /* false */));
