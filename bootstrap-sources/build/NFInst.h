...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFInst_markTypeModifier,2,0) {(void*) boxptr_NFInst_markTypeModifier,0}};
#define boxvar_NFInst_markTypeModifier MMC_REFSTRUCTLIT(boxvar_lit_NFInst_markTypeModifier)


DLLModelDirection
modelica_metatype omc_NFInst_instanceScope(threadData_t *threadData, modelica_metatype _node);
#define boxptr_NFInst_instanceScope omc_NFInst_instanceScope
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFInst_instanceScope,2,0) {(void*) boxptr_NFInst_instanceScope,0}};
#define boxvar_NFInst_instanceScope MMC_REFSTRUCTLIT(boxvar_lit_NFInst_instanceScope)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFInst_classConfidence,2,0) {(void*) boxptr_NFInst_classConfidence,0}};
#define boxvar_NFInst_classConfidence MMC_REFSTRUCTLIT(boxvar_lit_NFInst_classConfidence)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFInst_isAliasablePackage,2,0) {(void*) boxptr_NFInst_isAliasablePackage,0}};
#define boxvar_NFInst_isAliasablePackage MMC_REFSTRUCTLIT(boxvar_lit_NFInst_isAliasablePackage)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFInst_packageAlias,2,0) {(void*) boxptr_NFInst_packageAlias,0}};
#define boxvar_NFInst_packageAlias MMC_REFSTRUCTLIT(boxvar_lit_NFInst_packageAlias)
