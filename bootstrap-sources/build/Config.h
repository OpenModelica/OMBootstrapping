...
static const MMC_DEFSTRUCTLIT(boxvar_lit_Config_replacedHomotopy,2,0) {(void*) boxptr_Config_replacedHomotopy,0}};
#define boxvar_Config_replacedHomotopy MMC_REFSTRUCTLIT(boxvar_lit_Config_replacedHomotopy)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_Config_simCodeRustRuntime,2,0) {(void*) boxptr_Config_simCodeRustRuntime,0}};
#define boxvar_Config_simCodeRustRuntime MMC_REFSTRUCTLIT(boxvar_lit_Config_simCodeRustRuntime)


DLLModelDirection
modelica_string omc_Config_targetTriple(threadData_t *threadData);
#define boxptr_Config_targetTriple omc_Config_targetTriple
static const MMC_DEFSTRUCTLIT(boxvar_lit_Config_targetTriple,2,0) {(void*) boxptr_Config_targetTriple,0}};
#define boxvar_Config_targetTriple MMC_REFSTRUCTLIT(boxvar_lit_Config_targetTriple)
