    ...
    tmp4_1 = _tree;
    {
      ...
      // _outTree has no default value.
      {
        ...
        case 5: {
          ...
          tmpMeta5 = omc_mk_box3(4, &NFCallParameterTree_Tree_LEAF__desc, _inKey, _inValue);
          tmpMeta1 = tmpMeta5;
          goto tmp3_done;
        }
        case 3: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            ...
            ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta7))[5] = omc_NFCallParameterTree_add(threadData, (OMC_BOX_FIELD(_tree, 5)), _inKey, _inValue, ((modelica_fnptr) _conflictFunc));
            _tree = tmpMeta7;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              ...
              ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta8))[6] = omc_NFCallParameterTree_add(threadData, (OMC_BOX_FIELD(_tree, 6)), _inKey, _inValue, ((modelica_fnptr) _conflictFunc));
              _tree = tmpMeta8;
            }
            else
            {
        ...
        case 4: {
          ...
          /* Pattern matching succeeded */
          _key_comp = omc_NFCallParameterTree_keyCompare(threadData, _inKey, (OMC_BOX_FIELD(_tree, 2)));

          if((_key_comp == ((modelica_integer) -1)))
          {
            tmpMeta10 = omc_mk_box3(4, &NFCallParameterTree_Tree_LEAF__desc, _inKey, _inValue);
            tmpMeta11 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), (OMC_BOX_FIELD(_tree, 3)), omc_mk_integer(((modelica_integer) 2)), tmpMeta10, _OMC_LIT0);
            _outTree = tmpMeta11;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              tmpMeta12 = omc_mk_box3(4, &NFCallParameterTree_Tree_LEAF__desc, _inKey, _inValue);
              tmpMeta13 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), (OMC_BOX_FIELD(_tree, 3)), omc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta12);
              _outTree = tmpMeta13;
            }
            else
            {
    ...
    tmp4_1 = _tree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _key_comp = omc_NFCallParameterTree_keyCompare(threadData, _key, (OMC_BOX_FIELD(_tree, 2)));

          if((_key_comp == ((modelica_integer) -1)))
          {
            tmpMeta6 = MMC_TAGPTR(mmc_alloc_words(7));
            memcpy(MMC_UNTAGPTR(tmpMeta6), MMC_UNTAGPTR(_tree), 7*sizeof(modelica_metatype));
            ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[5] = omc_NFCallParameterTree_addUpdate(threadData, (OMC_BOX_FIELD(_tree, 5)), _key, ((modelica_fnptr) _fn));
            _tree = tmpMeta6;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              tmpMeta7 = MMC_TAGPTR(mmc_alloc_words(7));
              memcpy(MMC_UNTAGPTR(tmpMeta7), MMC_UNTAGPTR(_tree), 7*sizeof(modelica_metatype));
              ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta7))[6] = omc_NFCallParameterTree_addUpdate(threadData, (OMC_BOX_FIELD(_tree, 6)), _key, ((modelica_fnptr) _fn));
              _tree = tmpMeta7;
            }
            else
            {
        ...
        case 4: {
          ...
          if((_key_comp == ((modelica_integer) -1)))
          {
            tmpMeta9 = omc_mk_box3(4, &NFCallParameterTree_Tree_LEAF__desc, _key, (OMC_BOX_FIELD(_fn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), mmc_mk_none()) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, mmc_mk_none()));
            tmpMeta10 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), (OMC_BOX_FIELD(_tree, 3)), omc_mk_integer(((modelica_integer) 2)), tmpMeta9, _OMC_LIT0);
            _new_tree = tmpMeta10;
          }
          else
          {
            if((_key_comp == ((modelica_integer) 1)))
            {
              ...
              tmpMeta12 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_tree, 2)), (OMC_BOX_FIELD(_tree, 3)), omc_mk_integer(((modelica_integer) 2)), _OMC_LIT0, tmpMeta11);
              _new_tree = tmpMeta12;
            }
            else
            {
    ...
    tmp4_1 = _outTree;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          _lh = omc_NFCallParameterTree_height(threadData, (OMC_BOX_FIELD(_outTree, 5)));

          _rh = omc_NFCallParameterTree_height(threadData, (OMC_BOX_FIELD(_outTree, 6)));

          _diff = _lh - _rh;

          if((_diff < ((modelica_integer) -1)))
          {
            _balanced_tree = ((omc_NFCallParameterTree_calculateBalance(threadData, (OMC_BOX_FIELD(_outTree, 6))) > ((modelica_integer) 0))?omc_NFCallParameterTree_rotateLeft(threadData, omc_NFCallParameterTree_setTreeLeftRight(threadData, _outTree, (OMC_BOX_FIELD(_outTree, 5)), omc_NFCallParameterTree_rotateRight(threadData, (OMC_BOX_FIELD(_outTree, 6))))):omc_NFCallParameterTree_rotateLeft(threadData, _outTree));
          }
          else
          {
            if((_diff > ((modelica_integer) 1)))
            {
              _balanced_tree = ((omc_NFCallParameterTree_calculateBalance(threadData, (OMC_BOX_FIELD(_outTree, 5))) < ((modelica_integer) 0))?omc_NFCallParameterTree_rotateRight(threadData, omc_NFCallParameterTree_setTreeLeftRight(threadData, _outTree, omc_NFCallParameterTree_rotateLeft(threadData, (OMC_BOX_FIELD(_outTree, 5))), (OMC_BOX_FIELD(_outTree, 6)))):omc_NFCallParameterTree_rotateRight(threadData, _outTree));
            }
            else
            {
    ...
    tmp4_1 = _inNode;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_NFCallParameterTree_height(threadData, (OMC_BOX_FIELD(_inNode, 5))) - omc_NFCallParameterTree_height(threadData, (OMC_BOX_FIELD(_inNode, 6)));
          goto tmp3_done;
        }
        case 4: {
    ...
    tmp4_1 = _inTree;
    {
      ...
      // _value has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _outResult = omc_NFCallParameterTree_fold(threadData, (OMC_BOX_FIELD(_inTree, 5)), ((modelica_fnptr) _inFunc), _outResult);
    ...
    tmp4_1 = _tree;
    {
      ...
      // _c has no default value.
      {
        ...
        case 3: {
          ...
          if(_c)
          {
            _value = omc_NFCallParameterTree_foldCond(threadData, (OMC_BOX_FIELD(_tree, 5)), ((modelica_fnptr) _foldFunc), _value);

            _value = omc_NFCallParameterTree_foldCond(threadData, (OMC_BOX_FIELD(_tree, 6)), ((modelica_fnptr) _foldFunc), _value);
          }
          tmpMeta1 = _value;
          goto tmp3_done;
        }
    ...
    tmp3_1 = _tree;
    {
      int tmp3;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _foldArg1 = omc_NFCallParameterTree_fold__2(threadData, (OMC_BOX_FIELD(_tree, 5)), ((modelica_fnptr) _foldFunc), _foldArg1, _foldArg2 ,&_foldArg2);
          ...
          _foldArg1 = omc_NFCallParameterTree_fold__2(threadData, (OMC_BOX_FIELD(_tree, 6)), ((modelica_fnptr) _foldFunc), _foldArg1, _foldArg2 ,&_foldArg2);
          goto tmp2_done;
        }
        case 4: {
    ...
    tmp3_1 = _tree;
    {
      int tmp3;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          omc_NFCallParameterTree_forEach(threadData, (OMC_BOX_FIELD(_tree, 5)), ((modelica_fnptr) _func));
    ...
    tmp4_1 = _treeToJoin;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _tree = omc_NFCallParameterTree_add(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 2)), (OMC_BOX_FIELD(_treeToJoin, 3)), ((modelica_fnptr) _conflictFunc));

          _tree = omc_NFCallParameterTree_join(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 5)), ((modelica_fnptr) _conflictFunc));
          /* Tail recursive call */
        ...
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_NFCallParameterTree_add(threadData, _tree, (OMC_BOX_FIELD(_treeToJoin, 2)), (OMC_BOX_FIELD(_treeToJoin, 3)), ((modelica_fnptr) _conflictFunc));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
    ...
    tmp4_1 = _tree;
    {
      ...
      // _key has no default value.
      {
        ...
        case 3: {
          ...
          _key = tmpMeta5;
          /* Pattern matching succeeded */
          _lst = omc_NFCallParameterTree_listKeys(threadData, (OMC_BOX_FIELD(_tree, 6)), _lst);
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          _lst = omc_NFCallParameterTree_listKeysReverse(threadData, (OMC_BOX_FIELD(_inTree, 5)), _lst);
    ...
    tmp4_1 = _tree;
    {
      ...
      // _value has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta5;
          /* Pattern matching succeeded */
          _lst = omc_NFCallParameterTree_listValues(threadData, (OMC_BOX_FIELD(_tree, 6)), _lst);
    ...
    tmp4_1 = _outTree;
    {
      ...
      // _new_right has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _new_left = omc_NFCallParameterTree_map(threadData, (OMC_BOX_FIELD(_outTree, 5)), ((modelica_fnptr) _inFunc));
          ...
          _new_right = omc_NFCallParameterTree_map(threadData, (OMC_BOX_FIELD(_outTree, 6)), ((modelica_fnptr) _inFunc));
          ...
          {
            tmpMeta7 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, _key, _new_value, (OMC_BOX_FIELD(_outTree, 4)), _new_left, _new_right);
            _outTree = tmpMeta7;
          }
          tmpMeta1 = _outTree;
          goto tmp3_done;
    ...
    tmp4_1 = _outTree;
    {
      ...
      // _new_right has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _new_left = omc_NFCallParameterTree_mapFold(threadData, (OMC_BOX_FIELD(_outTree, 5)), ((modelica_fnptr) _inFunc), _outResult ,&_outResult);
          ...
          _new_right = omc_NFCallParameterTree_mapFold(threadData, (OMC_BOX_FIELD(_outTree, 6)), ((modelica_fnptr) _inFunc), _outResult ,&_outResult);
    ...
    tmp4_1 = _inNode;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp6 = stringAppend(_OMC_LIT1,omc_NFCallParameterTree_keyStr(threadData, (OMC_BOX_FIELD(_inNode, 2))));
          tmp7 = stringAppend(tmp6,_OMC_LIT2);
          tmp8 = stringAppend(tmp7,omc_NFCallParameterTree_valueStr(threadData, (OMC_BOX_FIELD(_inNode, 3))));
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmp10 = stringAppend(_OMC_LIT1,omc_NFCallParameterTree_keyStr(threadData, (OMC_BOX_FIELD(_inNode, 2))));
          tmp11 = stringAppend(tmp10,_OMC_LIT2);
          tmp12 = stringAppend(tmp11,omc_NFCallParameterTree_valueStr(threadData, (OMC_BOX_FIELD(_inNode, 3))));
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          _right = tmpMeta6;
          /* Pattern matching succeeded */
          tmp7 = stringAppend(omc_NFCallParameterTree_printTreeStr2(threadData, _left, 1 /* true */, _OMC_LIT5),omc_NFCallParameterTree_printNodeStr(threadData, _inTree));
          tmp8 = stringAppend(tmp7,_OMC_LIT6);
          tmp9 = stringAppend(tmp8,omc_NFCallParameterTree_printTreeStr2(threadData, _right, 0 /* false */, _OMC_LIT5));
          tmp1 = tmp9;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          tmp6 = stringAppend(omc_NFCallParameterTree_printTreeStr2(threadData, (OMC_BOX_FIELD(_inTree, 5)), 1 /* true */, tmp5),_inIndent);
          tmp7 = stringAppend(tmp6,(_isLeft?_OMC_LIT9:_OMC_LIT10));
          tmp8 = stringAppend(tmp7,_OMC_LIT11);
          tmp9 = stringAppend(tmp8,omc_NFCallParameterTree_printNodeStr(threadData, _inTree));
          tmp10 = stringAppend(tmp9,_OMC_LIT6);
          tmp11 = stringAppend(_inIndent,(_isLeft?_OMC_LIT8:_OMC_LIT7));
          tmp12 = stringAppend(tmp10,omc_NFCallParameterTree_printTreeStr2(threadData, (OMC_BOX_FIELD(_inTree, 6)), 0 /* false */, tmp11));
          tmp1 = tmp12;
          goto tmp3_done;
        }
        case 4: {
          ...
          tmp15 = stringAppend(tmp14,omc_NFCallParameterTree_printNodeStr(threadData, _inTree));
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _child = tmpMeta6;
          /* Pattern matching succeeded */
          _node = omc_NFCallParameterTree_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_outNode, 5)), (OMC_BOX_FIELD(_child, 5)));
          tmpMeta1 = omc_NFCallParameterTree_setTreeLeftRight(threadData, _child, _node, (OMC_BOX_FIELD(_child, 6)));
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
          ...
          _child = tmpMeta7;
          /* Pattern matching succeeded */
          _node = omc_NFCallParameterTree_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_outNode, 5)), _OMC_LIT0);
    ...
    tmp4_1 = _outNode;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _child = tmpMeta6;
          /* Pattern matching succeeded */
          _node = omc_NFCallParameterTree_setTreeLeftRight(threadData, _outNode, (OMC_BOX_FIELD(_child, 6)), (OMC_BOX_FIELD(_outNode, 6)));
          tmpMeta1 = omc_NFCallParameterTree_setTreeLeftRight(threadData, _child, (OMC_BOX_FIELD(_child, 5)), _node);
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta7;
          ...
          _child = tmpMeta7;
          /* Pattern matching succeeded */
          _node = omc_NFCallParameterTree_setTreeLeftRight(threadData, _outNode, _OMC_LIT0, (OMC_BOX_FIELD(_outNode, 6)));
    ...
    tmp4_3 = _right;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmpMeta6 = omc_mk_box3(4, &NFCallParameterTree_Tree_LEAF__desc, (OMC_BOX_FIELD(_orig, 2)), (OMC_BOX_FIELD(_orig, 3)));
          tmpMeta1 = tmpMeta6;
          goto tmp3_done;
        }
        case 1: {
        ...
        case 2: {
          ...
          /* Pattern matching succeeded */
          tmp8 = (modelica_boolean)(omc_NFCallParameterTree_referenceEqOrEmpty(threadData, (OMC_BOX_FIELD(_orig, 5)), _left) && omc_NFCallParameterTree_referenceEqOrEmpty(threadData, (OMC_BOX_FIELD(_orig, 6)), _right));
          if(tmp8)
          {
            tmpMeta9 = _orig;
          }
          ...
          {
            tmpMeta7 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_orig, 2)), (OMC_BOX_FIELD(_orig, 3)), omc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_NFCallParameterTree_height(threadData, _left)),(modelica_integer)(omc_NFCallParameterTree_height(threadData, _right)))), _left, _right);
            tmpMeta9 = tmpMeta7;
          }
          tmpMeta1 = tmpMeta9;
          goto tmp3_done;
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta10 = omc_mk_box6(3, &NFCallParameterTree_Tree_NODE__desc, (OMC_BOX_FIELD(_orig, 2)), (OMC_BOX_FIELD(_orig, 3)), omc_mk_integer(((modelica_integer) 1) + modelica_integer_max((modelica_integer)(omc_NFCallParameterTree_height(threadData, _left)),(modelica_integer)(omc_NFCallParameterTree_height(threadData, _right)))), _left, _right);
          tmpMeta1 = tmpMeta10;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      ...
      // _value has no default value.
      {
        ...
        case 3: {
          ...
          _value = tmpMeta6;
          /* Pattern matching succeeded */
          _lst = omc_NFCallParameterTree_toList(threadData, (OMC_BOX_FIELD(_inTree, 6)), _lst);
...
modelica_string omc_NFCallParameterTree_valueStr(threadData_t *threadData, modelica_metatype _inValue)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _outString has no default value.
  omc_string_store(&(_outString), omc_NFExpression_toString(threadData, _inValue));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outString;
  return omc_ret_;
}
