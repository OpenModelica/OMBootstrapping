  ...
  { /* matchcontinue expression */
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          tmp5 = stringAppend(_OMC_LIT0,_inName);
          tmp6 = stringAppend(tmp5,_OMC_LIT1);
          tmp7 = stringAppend(tmp6,omc_NFSCodeEnv_itemStr(threadData, _inRedeclare));
          ...
          tmp13 = stringAppend(_OMC_LIT3,stringDelimitList(tmpMeta9, _OMC_LIT5));
          tmp14 = stringAppend(tmp13,_OMC_LIT2);
          fputs(omc_string_data(tmp14),stdout);

          tmp15 = stringAppend(_OMC_LIT6,omc_NFSCodeEnv_getEnvName(threadData, _inEnv));
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmp17 = stringAppend(_OMC_LIT9,_inName);
  ...
  { /* matchcontinue expression */
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          modelica_string tmp16;
          /* Pattern matching succeeded */
          tmp5 = stringAppend(_OMC_LIT10,_inElementName);
          tmp6 = stringAppend(tmp5,_OMC_LIT11);
          tmp7 = stringAppend(tmp6,omc_NFSCodeEnv_getEnvName(threadData, _inEnv));
          tmp8 = stringAppend(tmp7,_OMC_LIT2);
          fputs(omc_string_data(tmp8),stdout);

          tmp9 = stringAppend(_OMC_LIT12,omc_NFSCodeEnv_itemStr(threadData, _inOldItem));
          tmp10 = stringAppend(tmp9,_OMC_LIT11);
          tmp11 = stringAppend(tmp10,omc_NFSCodeEnv_getEnvName(threadData, omc_NFSCodeEnv_getItemEnvNoFail(threadData, _inOldItem)));
          tmp12 = stringAppend(tmp11,_OMC_LIT2);
          fputs(omc_string_data(tmp12),stdout);

          tmp13 = stringAppend(_OMC_LIT13,omc_NFSCodeEnv_itemStr(threadData, _inNewItem));
          tmp14 = stringAppend(tmp13,_OMC_LIT11);
          tmp15 = stringAppend(tmp14,omc_NFSCodeEnv_getEnvName(threadData, omc_NFSCodeEnv_getItemEnvNoFail(threadData, _inNewItem)));
        ...
        case 1: {
          ...
          modelica_string tmp18;
          /* Pattern matching succeeded */
          tmp17 = stringAppend(_OMC_LIT15,_inElementName);
          tmp18 = stringAppend(tmp17,_OMC_LIT7);
          fputs(omc_string_data(tmp18),stdout);
          goto tmp2_done;
        }
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFSCodeFlattenRedeclare_propagateAttributes(threadData_t *threadData, modelica_metatype _inOriginalAttributes, modelica_metatype _inNewAttributes)
{
  ...
  tmpMeta15 = omc_mk_box7(3, &SCode_Attributes_ATTR__desc, _dims2, _ct2, _prl2, _var2, _dir2, _isf2);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFSCodeFlattenRedeclare_propagatePrefixes(threadData_t *threadData, modelica_metatype _inOriginalPrefixes, modelica_metatype _inNewPrefixes)
{
  ...
  tmpMeta10 = omc_mk_box6(3, &SCode_Prefixes_PREFIXES__desc, _vis2, _rdp, _fp, _io2, _rpp);
  _outNewPrefixes = tmpMeta10;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outNewPrefixes;
  return omc_ret_;
}
...
modelica_metatype omc_NFSCodeFlattenRedeclare_propagateAttributesClass(threadData_t *threadData, modelica_metatype _inOriginalClass, modelica_metatype _inNewClass)
{
  ...
  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta3,2,8) == 0) OMC_THROW_INTERNAL();
  ...
  tmpMeta11 = OMC_BOX_FIELD(tmpMeta3, 9);
  _name = tmpMeta4;
  _pref2 = tmpMeta5;
  _ep = tmpMeta6;
  _pp = tmpMeta7;
  ...
  tmpMeta12 = omc_mk_box9(5, &SCode_Element_CLASS__desc, _name, _pref2, _ep, _pp, _res, _cdef, _cmt, _info);
  _outNewClass = tmpMeta12;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outNewClass;
  return omc_ret_;
}
...
modelica_metatype omc_NFSCodeFlattenRedeclare_propagateAttributesVar(threadData_t *threadData, modelica_metatype _inOriginalVar, modelica_metatype _inNewVar)
{
  ...
  /* Pattern-matching assignment */
  tmpMeta4 = _inNewVar;
  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta4,3,8) == 0) OMC_THROW_INTERNAL();
  tmpMeta5 = OMC_BOX_FIELD(tmpMeta4, 2);
  tmpMeta6 = OMC_BOX_FIELD(tmpMeta4, 3);
  tmpMeta7 = OMC_BOX_FIELD(tmpMeta4, 4);
  tmpMeta8 = OMC_BOX_FIELD(tmpMeta4, 5);
  tmpMeta9 = OMC_BOX_FIELD(tmpMeta4, 6);
  tmpMeta10 = OMC_BOX_FIELD(tmpMeta4, 7);
  tmpMeta11 = OMC_BOX_FIELD(tmpMeta4, 8);
  tmpMeta12 = OMC_BOX_FIELD(tmpMeta4, 9);
  _name = tmpMeta5;
  _pref2 = tmpMeta6;
  _attr2 = tmpMeta7;
  _ty = tmpMeta8;
  ...
  tmpMeta13 = omc_mk_box9(6, &SCode_Element_COMPONENT__desc, _name, _pref2, _attr2, _ty, _mod, _cmt, _cond, _info);
    ...
    tmp4_2 = _inNewItem;
    {
      ...
      for (; tmp4 < 7; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta9 = omc_mk_box3(3, &NFSCodeEnv_Item_VAR__desc, _el2, _iu2);
          tmpMeta1 = tmpMeta9;
          goto tmp3_done;
        }
        case 1: {
          ...
          tmpMeta14 = omc_mk_box4(4, &NFSCodeEnv_Item_CLASS__desc, _el2, _env2, _ty2);
          tmpMeta1 = tmpMeta14;
          goto tmp3_done;
        }
        case 2: {
        ...
        case 5: {
          ...
          tmpMeta18 = omc_mk_box3(6, &NFSCodeEnv_Item_REDECLARED__ITEM__desc, _item, _env1);
          tmpMeta1 = tmpMeta18;
          goto tmp3_done;
        }
        case 6: {
    ...
    tmp4_1 = _inEnv;
    {
      ...
      for (; tmp4 < 1; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta12 = omc_mk_box5(3, &NFSCodeFlattenRedeclare_Replacement_REPLACED__desc, _inElementName, _old_item, _new_item, _env);
          tmpMeta11 = mmc_mk_cons(tmpMeta12, _repl);
          _repl = tmpMeta11;
          tmpMeta13 = omc_mk_box2(0, _env, _repl);
          tmpMeta1 = tmpMeta13;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inRedeclares;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta10 = omc_mk_box2(4, &NFSCodeEnv_Redeclaration_PROCESSED__MODIFIER__desc, _inRedeclare);
        ...
        case 2: {
          ...
          if (!listEmpty(tmp4_1)) goto tmp3_end;
          /* Pattern matching succeeded */
          tmpMeta15 = omc_mk_box2(4, &NFSCodeEnv_Redeclaration_PROCESSED__MODIFIER__desc, _inRedeclare);
    ...
    tmp4_2 = _inExtends;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta17 = omc_mk_box5(3, &NFSCodeEnv_Extends_EXTENDS__desc, _bc2, _redecls, omc_mk_integer(_index), _info);
        ...
        case 3: {
          ...
          omc_string_store(&(_bcl_str), stringDelimitList(_bc_strl, _OMC_LIT5));

          tmp25 = stringAppend(_OMC_LIT22,_bcl_str);
          tmp26 = stringAppend(tmp25,_OMC_LIT23);
          tmp27 = stringAppend(tmp26,_inName);
          omc_string_store(&(_err_msg), tmp27);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFSCodeFlattenRedeclare_pushRedeclareIntoExtends(threadData_t *threadData, modelica_string _inName, modelica_metatype _inRedeclare, modelica_metatype _inBaseClasses, modelica_metatype _inEnv)
{
  ...
  tmpMeta11 = omc_mk_box4(3, &NFSCodeEnv_ExtendsTable_EXTENDS__TABLE__desc, _exts, _re, _cei);
  _etNew = tmpMeta11;

  _env = omc_NFSCodeEnv_setEnvExtendsTable(threadData, _etNew, _env);

  tmpMeta13 = omc_mk_box7(4, &NFSCodeFlattenRedeclare_Replacement_PUSHED__desc, _inName, _inRedeclare, _inBaseClasses, _etOld, _etNew, _env);
  tmpMeta12 = mmc_mk_cons(tmpMeta13, _repl);
  _repl = tmpMeta12;

  tmpMeta14 = omc_mk_box2(0, _env, _repl);
  _outEnv = tmpMeta14;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outEnv;
  return omc_ret_;
    ...
    tmp4_1 = _inRedeclare;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _item = tmpMeta6;
          /* Pattern matching succeeded */
          omc_string_store(&(_name), omc_NFSCodeEnv_getItemName(threadData, _item));
        ...
        case 2: {
          ...
          _item = tmpMeta8;
          /* Pattern matching succeeded */
          omc_string_store(&(_scope_name), omc_NFSCodeEnv_getScopeName(threadData, omc_Util_tuple21(threadData, _inEnv)));
    ...
    tmp4_1 = _inMod;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          _el = tmpMeta7;
          /* Pattern matching succeeded */
          tmpMeta8 = omc_mk_box2(3, &NFSCodeEnv_Redeclaration_RAW__MODIFIER__desc, _el);
          _redecl = tmpMeta8;
    ...
    tmp4_2 = _inItem;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 1: {
          ...
          tmpMeta13 = omc_mk_box2(0, _env, tmpMeta12);
          ...
          tmpMeta21 = omc_mk_box4(4, &NFSCodeEnv_Item_CLASS__desc, _cls, tmpMeta20, _cls_ty);
        ...
        case 2: {
          ...
          tmp23 = stringAppend(_OMC_LIT30,stringDelimitList(omc_List_map(threadData, _inRedeclares, boxvar_NFSCodeEnv_printRedeclarationStr), _OMC_LIT31));
          tmp24 = stringAppend(tmp23,_OMC_LIT32);
          tmp25 = stringAppend(tmp24,omc_NFSCodeEnv_itemStr(threadData, _inItem));
          tmp26 = stringAppend(tmp25,_OMC_LIT33);
          tmp27 = stringAppend(tmp26,omc_NFSCodeEnv_getEnvName(threadData, _inElementEnv));
    ...
    tmp4_1 = _inRedeclare;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta7 = omc_mk_box3(6, &NFSCodeEnv_Item_REDECLARED__ITEM__desc, _el_item, _inEnv);
          _redecl_item = tmpMeta7;
          tmpMeta8 = omc_mk_box2(4, &NFSCodeEnv_Redeclaration_PROCESSED__MODIFIER__desc, _redecl_item);
          tmpMeta1 = tmpMeta8;
          goto tmp3_done;
        }
        case 1: {
          ...
          tmpMeta10 = omc_mk_box3(6, &NFSCodeEnv_Item_REDECLARED__ITEM__desc, _el_item, _inEnv);
          _redecl_item = tmpMeta10;
          tmpMeta11 = omc_mk_box2(4, &NFSCodeEnv_Redeclaration_PROCESSED__MODIFIER__desc, _redecl_item);
          tmpMeta1 = tmpMeta11;
          goto tmp3_done;
        }
        case 2: {
        ...
        case 3: {
          ...
          tmp13 = stringAppend(_OMC_LIT36,omc_SCodeDump_unparseElementStr(threadData, omc_NFSCodeEnv_getRedeclarationElement(threadData, _inRedeclare), _OMC_LIT37));
          tmp14 = stringAppend(tmp13,_OMC_LIT38);
          tmp15 = stringAppend(tmp14,omc_AbsynUtil_pathString(threadData, omc_NFSCodeEnv_getEnvPath(threadData, _inEnv), _OMC_LIT4, 1 /* true */, 0 /* false */));
    ...
    tmp4_2 = _inExtends;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta16 = omc_mk_box2(4, &NFSCodeEnv_Redeclaration_PROCESSED__MODIFIER__desc, _inRedeclaredElement);
          _redecl = tmpMeta16;

          omc_NFSCodeCheck_checkDuplicateRedeclarations(threadData, _redecl, _el);

          tmpMeta17 = mmc_mk_cons(_redecl, _el);
          tmpMeta18 = omc_mk_box5(3, &NFSCodeEnv_Extends_EXTENDS__desc, _bc2, tmpMeta17, omc_mk_integer(_index), _info);
          _ex = tmpMeta18;
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFSCodeFlattenRedeclare_addRedeclareToEnvExtendsTable(threadData_t *threadData, modelica_metatype _inRedeclaredElement, modelica_metatype _inBaseClasses, modelica_metatype _inEnv, modelica_metatype _inInfo)
{
  ...
  tmpMeta5 = omc_mk_box4(3, &NFSCodeEnv_ExtendsTable_EXTENDS__TABLE__desc, _bcl, _re, _cei);
  ...
  { /* matchcontinue expression */
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          modelica_metatype tmpMeta6;
          /* Pattern matching succeeded */
          omc_string_store(&(_name), omc_SCodeUtil_elementName(threadData, _inRedeclare));
          ...
          tmpMeta6 = omc_mk_box4(5, &NFSCodeEnv_Item_ALIAS__desc, _name, mmc_mk_some(_env_path), _info);
          _item = tmpMeta6;
        ...
        case 1: {
          ...
          tmp8 = stringAppend(_OMC_LIT41,omc_SCodeUtil_elementName(threadData, _inRedeclare));
          tmp9 = stringAppend(tmp8,_OMC_LIT38);
