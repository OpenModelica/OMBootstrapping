...
static const MMC_DEFSTRUCTLIT(boxvar_lit_CodegenWasmJit_fmuAcceptsFlag,2,0) {(void*) boxptr_CodegenWasmJit_fmuAcceptsFlag,0}};
#define boxvar_CodegenWasmJit_fmuAcceptsFlag MMC_REFSTRUCTLIT(boxvar_lit_CodegenWasmJit_fmuAcceptsFlag)
