...
#define _OMC_LIT9_data " /* confidence = "
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT17,1,10) {&NFBinding_WILD__desc,}};
#define _OMC_LIT17 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT17)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT18,1,4) {&NFPrefixes_Replaceable_NOT__REPLACEABLE__desc,}};
#define _OMC_LIT18 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT18)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT19,10,3) {&NFAttributes_ATTRIBUTES__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(0)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),MMC_IMMEDIATE(MMC_TAGFIXNUM(7)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT18,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */))}};
#define _OMC_LIT19 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT19)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT20,1,13) {&NFType_UNKNOWN__desc,}};
#define _OMC_LIT20 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT20)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT21,1,5) {&NFModifier_Modifier_NOMOD__desc,}};
...
modelica_metatype boxptr_NFComponent_countConnectorVars(threadData_t *threadData, modelica_metatype _component, modelica_metatype _isRoot, modelica_metatype *out_flows, modelica_metatype *out_streams, modelica_metatype *out_knownSize)
{
  ...
  tmp1 = omc_unbox_integer(_isRoot);
  _potentials = omc_NFComponent_countConnectorVars(threadData, _component, tmp1, &_flows, &_streams, &_knownSize);
  out_potentials = omc_mk_icon(_potentials);
  if (out_flows) { *out_flows = omc_mk_icon(_flows); }
  if (out_streams) { *out_streams = omc_mk_icon(_streams); }
  if (out_knownSize) { *out_knownSize = omc_mk_icon(_knownSize); }
...
modelica_metatype boxptr_NFComponent_isTypeAttribute(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_isAttribute = omc_mk_icon(_isAttribute);
  return out_isAttribute;
}

DLLModelDirection
modelica_boolean omc_NFComponent_isIterator(threadData_t *threadData, modelica_metatype _component)
{
...
modelica_metatype boxptr_NFComponent_isIterator(threadData_t *threadData, modelica_metatype _component)
{
  modelica_boolean _iterator;
  modelica_metatype out_iterator;
  _iterator = omc_NFComponent_isIterator(threadData, _component);
...
modelica_metatype boxptr_NFComponent_isInvalid(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_invalid = omc_mk_icon(_invalid);
  return out_invalid;
}
...
modelica_string omc_NFComponent_getUnitAttribute(threadData_t *threadData, modelica_metatype _component, modelica_string _defaultUnit)
{
  ...
  {
    omc_string_store(&(_unitString), _defaultUnit);
    ...
    tmp4_1 = _component;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_Util_getOption(threadData, omc_SCodeUtil_getElementComment(threadData, (OMC_BOX_FIELD(_component, 2))));
          goto tmp3_done;
        }
        case 4: {
          
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 7));
          goto tmp3_done;
        }
        case 6: {
          
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 3));
          goto tmp3_done;
        }
        default:
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_NFType_dimensionCount(threadData, (OMC_BOX_FIELD(_component, 3)));
          goto tmp3_done;
        }
        case 1: {
...
modelica_metatype omc_NFComponent_typeAttrsToFlatStream(threadData_t *threadData, modelica_metatype _typeAttrs, modelica_metatype _componentType, modelica_metatype _format, modelica_metatype __omcQ_24in_5Fs)
{
  ...
  while(1)
  {
    ...
    if(omc_unbox_boolean((OMC_BOX_FIELD(_format, 5))))
    {
      _s = omc_IOStream_append(threadData, _s, _OMC_LIT9);

      tmp4 = modelica_integer_to_modelica_string(omc_NFBinding_actualConfidence(threadData, _binding), ((modelica_integer) 0), 1 /* true */);
      _s = omc_IOStream_append(threadData, _s, tmp4);
    ...
    tmp3_1 = _component;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          _s = omc_NFAttributes_toFlatStream(threadData, (OMC_BOX_FIELD(_component, 6)), (OMC_BOX_FIELD(_component, 3)), _s, 1 /* true */);

          _s = omc_IOStream_append(threadData, _s, omc_NFType_toFlatString(threadData, omc_NFType_arrayElementType(threadData, (OMC_BOX_FIELD(_component, 3))), _format));
          ...
          _dims = omc_NFType_arrayDims(threadData, (OMC_BOX_FIELD(_component, 3)));

          if((!listEmpty(_dims)))
          {
            _s = omc_IOStream_append(threadData, _s, omc_NFDimension_toFlatStringList(threadData, _dims, _format, _OMC_LIT1));
          }

          {
            ...
            _a_loopVar = omc_NFClass_getTypeAttributes(threadData, omc_NFInstNode_InstNode_getClass(threadData, (OMC_BOX_FIELD(_component, 2))));
            ...
            while(1) {
              ...
              if (tmp9 == 0) {
                tmpMeta8 = omc_mk_box2(0, omc_NFModifier_Modifier_name(threadData, _a), omc_NFModifier_Modifier_binding(threadData, _a));
          ...
          _s = omc_NFComponent_typeAttrsToFlatStream(threadData, _ty_attrs, (OMC_BOX_FIELD(_component, 3)), _format, _s);

          _s = omc_IOStream_append(threadData, _s, omc_NFBinding_toFlatString(threadData, (OMC_BOX_FIELD(_component, 4)), _format, _OMC_LIT8));
          goto tmp2_done;
        }
        case 1: {
          ...
          _s = omc_IOStream_append(threadData, _s, omc_NFModifier_Modifier_toFlatString(threadData, (OMC_BOX_FIELD(_component, 3)), _format, 0 /* false */));
          goto tmp2_done;
        }
        }
        goto tmp2_end;
    ...
    tmp4_1 = _component;
    {
      ...
      // _def has no default value.
      {
        ...
        case 3: {
          ...
          _def = tmpMeta5;
          /* Pattern matching succeeded */
          tmp1 = omc_SCodeDump_unparseElementStr(threadData, _def, _OMC_LIT14);
          goto tmp3_done;
        }
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmp6 = stringAppend(omc_NFAttributes_toString(threadData, (OMC_BOX_FIELD(_component, 6)), (OMC_BOX_FIELD(_component, 3))),omc_NFType_toString(threadData, (OMC_BOX_FIELD(_component, 3))));
          tmp7 = stringAppend(tmp6,_OMC_LIT13);
          tmp8 = stringAppend(tmp7,_name);
          tmp9 = stringAppend(tmp8,omc_NFBinding_toString(threadData, (OMC_BOX_FIELD(_component, 4)), _OMC_LIT8));
          tmp1 = tmp9;
          goto tmp3_done;
        }
        case 7: {
          ...
          /* Pattern matching succeeded */
          tmp10 = stringAppend(_name,omc_NFModifier_Modifier_toString(threadData, (OMC_BOX_FIELD(_component, 3)), 0 /* false */));
          tmp1 = tmp10;
          goto tmp3_done;
        }
        }
      ...
      tmp4_2 = _comp2;
      {
        ...
        for (; tmp4 < 2; tmp4++) {
          ...
          case 0: {
            ...
            /* Pattern matching succeeded */
            if((!omc_NFClass_isIdentical(threadData, omc_NFInstNode_InstNode_getClass(threadData, (OMC_BOX_FIELD(_comp1, 2))), omc_NFInstNode_InstNode_getClass(threadData, (OMC_BOX_FIELD(_comp2, 2))))))
            {
              goto _return;
            }

            if((!omc_NFBinding_isEqual(threadData, (OMC_BOX_FIELD(_comp1, 4)), (OMC_BOX_FIELD(_comp2, 4)))))
            {
              goto _return;
            }
            tmp1 = 1 /* true */;
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_NFClass_isExternalObject(threadData, omc_NFInstNode_InstNode_getClass(threadData, (OMC_BOX_FIELD(_component, 2))));
          goto tmp3_done;
        }
        case 1: {
          if (mmc__uniontype__metarecord__typedef__equal(tmp4_1,1,8) == 0) goto tmp3_end;
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_NFType_isExternalObject(threadData, (OMC_BOX_FIELD(_component, 3)));
          goto tmp3_done;
        }
        case 2: {
...
modelica_metatype boxptr_NFComponent_isFlow(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_isFlow = omc_mk_icon(_isFlow);
  return out_isFlow;
}
    ...
    tmp3_1 = _component;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[2] = omc_mk_integer(_cty);
          _attr = tmpMeta6;
...
modelica_metatype boxptr_NFComponent_isInnerOuter(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_isInnerOuter = omc_mk_icon(_isInnerOuter);
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_NFPrefixes_innerOuterFromSCode(threadData, omc_SCodeUtil_prefixesInnerOuter(threadData, omc_SCodeUtil_elementPrefixes(threadData, (OMC_BOX_FIELD(_component, 2)))));
          goto tmp3_done;
        }
        case 2: {
    ...
    tmp3_1 = _component;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          tmpMeta6 = MMC_TAGPTR(mmc_alloc_words(11));
          memcpy(MMC_UNTAGPTR(tmpMeta6), MMC_UNTAGPTR(_attr), 11*sizeof(modelica_metatype));
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[7] = omc_mk_boolean(_isFinal);
          _attr = tmpMeta6;
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_SCodeUtil_finalBool(threadData, omc_SCodeUtil_prefixesFinal(threadData, omc_SCodeUtil_elementPrefixes(threadData, (OMC_BOX_FIELD(_component, 2)))));
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta6;
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_SCodeUtil_isElementRedeclare(threadData, (OMC_BOX_FIELD(_component, 2)));
          goto tmp3_done;
        }
        case 1: {
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 5; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmp1 = omc_unbox_integer((OMC_BOX_FIELD(_component, 3)));
          goto tmp3_done;
        }
        case 2: {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          /* Tail recursive call */
          _component = (OMC_BOX_FIELD(_component, 2));
          goto _tailrecursive;
...
modelica_metatype boxptr_NFComponent_parallelism(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_parallelism = omc_mk_icon(_parallelism);
    ...
    tmp3_1 = _component;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 0: {
          ...
          tmpMeta6 = MMC_TAGPTR(mmc_alloc_words(11));
          memcpy(MMC_UNTAGPTR(tmpMeta6), MMC_UNTAGPTR(_attr), 11*sizeof(modelica_metatype));
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[5] = omc_mk_integer((modelica_integer)_direction);
          _attr = tmpMeta6;
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 5));
          goto tmp3_done;
        }
        case 1: {
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFComponent_hasBinding_has__missing__binding(threadData_t *threadData, modelica_metatype _component)
{
  ...
  _noBinding = (omc_NFInstNode_InstNode_isComponent(threadData, _component) && (!omc_NFComponent_hasBinding(threadData, omc_NFInstNode_InstNode_component(threadData, _component), _OMC_LIT16)));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _noBinding;
  return omc_ret_;
}
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFComponent_hasBinding_has__missing__binding(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_noBinding = omc_mk_icon(_noBinding);
    ...
    tmp3_1 = _component;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 1: {
          ...
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[3] = omc_NFModifier_Modifier_setBinding(threadData, _binding, (OMC_BOX_FIELD(_component, 3)));
          _component = tmpMeta6;
          goto tmp2_done;
        }
        }
          ...
          for (; tmp3 < 2; tmp3++) {
            ...
            case 0: {
              ...
              if(omc_NFComponent_isTyped(threadData, _component))
              {
                ...
                _binding = omc_NFBinding_makeTyped(threadData, _record_exp, 1, 4, omc_NFComponent_info(threadData, _component), 1, ((modelica_integer) 99999));
              }
              else
              {
                _record_exp = omc_NFClass_makeRecordExp(threadData, _cls_node, _scope, 0 /* false */);

                _binding = omc_NFBinding_makeUntyped(threadData, _record_exp, _scope, 1, 4, omc_NFComponent_info(threadData, _component), ((modelica_integer) 99999));
              }
              goto tmp2_done;
            }
            case 1: {
    ...
    tmp4_1 = _component;
    {
      int tmp4;
      {
        ...
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 4));
          goto tmp3_done;
        }
        case 7: {
          
          /* Pattern matching succeeded */
          tmpMeta1 = omc_NFModifier_Modifier_binding(threadData, (OMC_BOX_FIELD(_component, 3)));
          goto tmp3_done;
        }
        case 9: {
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 6));
          goto tmp3_done;
        }
        case 1: {
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 5; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = (omc_unbox_integer((OMC_BOX_FIELD(_component, 8))) >= 3);
          goto tmp3_done;
        }
        case 1: {
          modelica_metatype tmpMeta6;
...
modelica_metatype boxptr_NFComponent_isTyped(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_isTyped = omc_mk_icon(_isTyped);
  return out_isTyped;
}
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 6; tmp4++) {
        ...
        case 0: {
          ...
          _t = tmpMeta6;
          /* Pattern matching succeeded */
          tmpMeta1 = omc_NFType_liftArrayLeftList(threadData, omc_NFInstNode_InstNode_getType(threadData, (OMC_BOX_FIELD(_component, 2))), arrayList((OMC_BOX_FIELD(_t, 3))));
          goto tmp3_done;
        }
        case 1: {
          if (mmc__uniontype__metarecord__typedef__equal(tmp4_1,1,8) == 0) goto tmp3_end;
        ...
        case 2: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 2));
          goto tmp3_done;
        }
        case 3: {
          if (mmc__uniontype__metarecord__typedef__equal(tmp4_1,4,2) == 0) goto tmp3_end;
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta6 = MMC_TAGPTR(mmc_alloc_words(4));
          memcpy(MMC_UNTAGPTR(tmpMeta6), MMC_UNTAGPTR(_component), 4*sizeof(modelica_metatype));
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[3] = omc_NFModifier_Modifier_merge(threadData, _modifier, (OMC_BOX_FIELD(_component, 3)), _OMC_LIT1);
          _component = tmpMeta6;
          tmpMeta1 = _component;
          goto tmp3_done;
        }
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmpMeta7 = omc_mk_box3(7, &NFComponent_TYPE__ATTRIBUTE__desc, (OMC_BOX_FIELD(_component, 2)), omc_NFModifier_Modifier_merge(threadData, _modifier, (OMC_BOX_FIELD(_component, 3)), _OMC_LIT1));
          tmpMeta1 = tmpMeta7;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _component;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_NFType_complexNode(threadData, (OMC_BOX_FIELD(_component, 2)));
          goto tmp3_done;
        }
        case 2: {
          modelica_metatype tmpMeta7;
          ...
          /* Pattern matching succeeded */
          tmpMeta7 = omc_mk_box2(33, &NFExpression_EMPTY__desc, (OMC_BOX_FIELD(_component, 2)));
          tmpMeta8 = omc_mk_box2(9, &NFInstNode_InstNode_ITERATOR__NODE__desc, tmpMeta7);
          tmpMeta1 = tmpMeta8;
          goto tmp3_done;
        }
        case 3: {
    ...
    tmp4_1 = _component;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_SCodeUtil_elementInfo(threadData, (OMC_BOX_FIELD(_component, 2)));
          goto tmp3_done;
        }
        case 4: {
          
          /* Pattern matching succeeded */
          tmpMeta1 = (OMC_BOX_FIELD(_component, 9));
          goto tmp3_done;
        }
        case 5: {
        ...
        case 7: {
          ...
          /* Pattern matching succeeded */
          tmpMeta1 = omc_NFModifier_Modifier_info(threadData, (OMC_BOX_FIELD(_component, 3)));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
...
modelica_metatype boxptr_NFComponent_isDefinition(threadData_t *threadData, modelica_metatype _component)
{
  ...
  out_isDefinition = omc_mk_icon(_isDefinition);
...
modelica_metatype omc_NFComponent_newIterator(threadData_t *threadData, modelica_metatype _iterType, modelica_metatype _info)
{
  ...
  tmpMeta1 = omc_mk_box4(5, &NFComponent_ITERATOR__desc, _iterType, omc_mk_integer(6), _info);
  _component = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _component;
  return omc_ret_;
...
modelica_metatype omc_NFComponent_newEnum(threadData_t *threadData, modelica_metatype _enumType, modelica_string _literalName, modelica_metatype _comment, modelica_integer _literalIndex)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _component has no default value.
  tmpMeta1 = omc_mk_box4(7, &NFExpression_ENUM__LITERAL__desc, _enumType, _literalName, omc_mk_integer(_literalIndex));
  tmpMeta2 = omc_mk_box3(6, &NFComponent_ENUM__LITERAL__desc, tmpMeta1, _comment);
  _component = tmpMeta2;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _component;
  return omc_ret_;
...
modelica_metatype boxptr_NFComponent_newEnum(threadData_t *threadData, modelica_metatype _enumType, modelica_metatype _literalName, modelica_metatype _comment, modelica_metatype _literalIndex)
{
  modelica_integer tmp1;
  modelica_metatype _component = NULL;
  tmp1 = omc_unbox_integer(_literalIndex);
...
modelica_metatype omc_NFComponent_new(threadData_t *threadData, modelica_metatype _definition)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _component has no default value.
  tmpMeta1 = omc_mk_box3(3, &NFComponent_COMPONENT__DEF__desc, _definition, _OMC_LIT21);
  _component = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _component;
  return omc_ret_;
