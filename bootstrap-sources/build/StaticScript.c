...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT62,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(113)),_OMC_LIT9,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT59,_OMC_LIT60,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT61}};
