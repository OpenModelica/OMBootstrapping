        ...
        case 0: {
          ...
          _names = omc_List_map1(threadData, _names, boxvar_AbsynUtil_joinPaths, _scope);
          {
            ...
            while(1) {
              ...
              if (tmp17 == 0) {
                __omcQ_24tmpVar4 = omc_AbsynUtil_pathString(threadData, _n, _OMC_LIT75, 1 /* true */, 0 /* false */);
        ...
        case 1: {
          ...
          _names = tmpMeta22;
          {
            ...
            while(1) {
              ...
              if (tmp30 == 0) {
                __omcQ_24tmpVar8 = omc_AbsynUtil_pathString(threadData, _n, _OMC_LIT75, 1 /* true */, 0 /* false */);
