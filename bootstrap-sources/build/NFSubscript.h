...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFSubscript_hashStringContinue,2,0) {(void*) boxptr_NFSubscript_hashStringContinue,0}};
#define boxvar_NFSubscript_hashStringContinue MMC_REFSTRUCTLIT(boxvar_lit_NFSubscript_hashStringContinue)
