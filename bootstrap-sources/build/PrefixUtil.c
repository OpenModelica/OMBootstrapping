...
#define _OMC_LIT2_data "/home/adrpo33/OpenModelica/OMCompiler/Compiler/FrontEnd/PrefixUtil.mo"
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT3,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT2,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1543)),MMC_IMMEDIATE(MMC_TAGFIXNUM(7)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1543)),MMC_IMMEDIATE(MMC_TAGFIXNUM(158)),_OMC_LIT3_6}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT5,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT2,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1548)),MMC_IMMEDIATE(MMC_TAGFIXNUM(7)),MMC_IMMEDIATE(MMC_TAGFIXNUM(1548)),MMC_IMMEDIATE(MMC_TAGFIXNUM(122)),_OMC_LIT5_6}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT16,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT2,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(962)),MMC_IMMEDIATE(MMC_TAGFIXNUM(9)),MMC_IMMEDIATE(MMC_TAGFIXNUM(962)),MMC_IMMEDIATE(MMC_TAGFIXNUM(151)),_OMC_LIT16_6}};
        ...
        tmp5_1 = _st;
        {
          ...
          // _elseBranch has no default value.
          {
            ...
            case 7: {
              ...
              if (mmc__uniontype__metarecord__typedef__equal(tmp5_1,4,6) == 0) goto tmp4_end;
              ...
              tmpMeta31 = mmc_mk_box7(7, &DAE_Statement_STMT__FOR__desc, _t, mmc_mk_boolean(_bool), _id, _e, _sList, _source);
              _elem = tmpMeta31;

              tmpMeta32 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta32;
              goto tmp4_done;
            }
            case 6: {
              ...
              tmpMeta34 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 3));
              tmpMeta35 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 4));
              tmpMeta36 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 5));
              _e1 = tmpMeta33;
              _sList = tmpMeta34;
              _elseBranch = tmpMeta35;
              _source = tmpMeta36;
              /* Pattern matching succeeded */
              _outCache = omc_PrefixUtil_prefixExpWork(threadData, _outCache, _env, _inIH, _e1, _p ,&_e1);
              ...
              tmpMeta37 = mmc_mk_box5(6, &DAE_Statement_STMT__IF__desc, _e1, _sList, _elseBranch, _source);
              _elem = tmpMeta37;

              tmpMeta38 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta38;
              goto tmp4_done;
            }
            case 9: {
              ...
              tmpMeta40 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 3));
              tmpMeta41 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 4));
              _e1 = tmpMeta39;
              _sList = tmpMeta40;
              _source = tmpMeta41;
              /* Pattern matching succeeded */
              ...
              tmpMeta42 = mmc_mk_box4(9, &DAE_Statement_STMT__WHILE__desc, _e1, _sList, _source);
              _elem = tmpMeta42;

              tmpMeta43 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta43;
              goto tmp4_done;
            }
            case 11: {
              ...
              tmpMeta44 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 2));
              tmpMeta45 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 3));
              tmpMeta46 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 4));
              tmpMeta47 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 5));
              _e1 = tmpMeta44;
              _e2 = tmpMeta45;
              _e3 = tmpMeta46;
              _source = tmpMeta47;
              ...
              tmpMeta48 = mmc_mk_box5(11, &DAE_Statement_STMT__ASSERT__desc, _e1, _e2, _e3, _source);
              _elem = tmpMeta48;

              tmpMeta49 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta49;
              goto tmp4_done;
            }
            case 19: {
              ...
              tmpMeta50 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 2));
              tmpMeta51 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 3));
              _b = tmpMeta50;
              _source = tmpMeta51;
              /* Pattern matching succeeded */
              _outCache = omc_PrefixUtil_prefixStatements(threadData, _outCache, _env, _inIH, _b, _p ,&_b);

              tmpMeta52 = mmc_mk_box3(19, &DAE_Statement_STMT__FAILURE__desc, _b, _source);
              _elem = tmpMeta52;

              tmpMeta53 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta53;
              goto tmp4_done;
            }
            case 15: {
              ...
              tmpMeta54 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp5_1), 2));
              _source = tmpMeta54;
              /* Pattern matching succeeded */
              tmpMeta55 = mmc_mk_box2(15, &DAE_Statement_STMT__RETURN__desc, _source);
              _elem = tmpMeta55;

              tmpMeta56 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta56;
              goto tmp4_done;
            }
            case 16: {
              ...
              _source = tmpMeta57;
              /* Pattern matching succeeded */
              tmpMeta58 = mmc_mk_box2(16, &DAE_Statement_STMT__BREAK__desc, _source);
              _elem = tmpMeta58;

              tmpMeta59 = mmc_mk_cons(_elem, _outStmts);
              _outStmts = tmpMeta59;
              goto tmp4_done;
            }
            }
    ...
    tmp4_2 = _pre;
    {
      ...
      for (; tmp4 < 41; tmp4++) {
        ...
        case 9: {
          ...
          _e1 = tmpMeta16;
          _index_ = tmp18  /* pattern as ty=Integer */;
          _t = tmpMeta19;
          /* Pattern matching succeeded */
          _cache = omc_PrefixUtil_prefixExpWork(threadData, _cache, _env, _ih, _e1, _pre ,&_e1);
        ...
        case 14: {
          ...
          _o = tmpMeta36;
          _e2 = tmpMeta37;
          _index_ = tmp39  /* pattern as ty=Integer */;
        ...
        case 22: {
          ...
          _t = tmpMeta64;
          _sc = tmp66  /* pattern as ty=Boolean */;
          _es = tmpMeta67;
          /* Pattern matching succeeded */
          _cache = omc_PrefixUtil_prefixExpList(threadData, _cache, _env, _ih, _es, _pre ,&_es_1);
        ...
        case 25: {
          ...
          _t = tmpMeta72;
          _a = tmp74  /* pattern as ty=Integer */;
          _x = tmpMeta76;
          _xs = tmpMeta77;
          /* Pattern matching succeeded */
