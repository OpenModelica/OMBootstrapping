...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT16,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(99)),_OMC_LIT14,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT15}};
...
#define _OMC_LIT74_data "//OpenModelica/OMCompiler/Compiler/BackEnd/EvaluateFunctions.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT74,86,_OMC_LIT74_data);
#define _OMC_LIT74 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT74)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT75_6,1.786954567e9);
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT109,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(118)),_OMC_LIT105,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT106,_OMC_LIT107,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT108}};
      ...
      for (; tmp8 < 2; tmp8++) {
        ...
        case 1: {
...

          {
            ...
            _e_loopVar = _lhsExps;
            tmpMeta22 = MMC_REFSTRUCTLIT(mmc_nil);
            __omcQ_24tmpVar25 = tmpMeta22; /* defaultValue */
            tmp21 = &__omcQ_24tmpVar25;
            while(1) {
              tmp23 = 1;
              ...
              if (tmp23 == 0) {
                ...
                *tmp21 = mmc_mk_cons(__omcQ_24tmpVar24,0);
                tmp21 = &MMC_CDR(*tmp21);
              } else if (tmp23 == 1) {
                break;
              } else {
      ...
      for (; tmp5 < 3; tmp5++) {
        ...
        case 0: {
...

          {
            ...
            _e_loopVar = _expsIn;
            tmpMeta23 = MMC_REFSTRUCTLIT(mmc_nil);
            __omcQ_24tmpVar33 = tmpMeta23; /* defaultValue */
