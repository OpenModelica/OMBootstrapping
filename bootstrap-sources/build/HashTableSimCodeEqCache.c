...
modelica_metatype omc_HashTableSimCodeEqCache_emptyHashTableSized(threadData_t *threadData, modelica_integer _size)
{
  ...
  tmpMeta1 = omc_mk_box4(0, boxvar_SimCodeUtil_hashEqSystem, boxvar_SimCodeUtil_compareEqSystemsEquality, boxvar_SimCodeUtil_simEqSystemString, boxvar_intString);
