...
DLLModelDirection
void omc_System_waitForInput(threadData_t *threadData);
#define boxptr_System_waitForInput omc_System_waitForInput
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_waitForInput,2,0) {(void*) boxptr_System_waitForInput,0}};
#define boxvar_System_waitForInput MMC_REFSTRUCTLIT(boxvar_lit_System_waitForInput)

extern void SystemImpl__waitForInput();

DLLModelDirection
modelica_integer omc_System_fputs(threadData_t *threadData, modelica_string _str, modelica_integer _streamType);
DLLModelDirection
modelica_metatype boxptr_System_fputs(threadData_t *threadData, modelica_metatype _str, modelica_metatype _streamType);
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_fputs,2,0) {(void*) boxptr_System_fputs,0}};
#define boxvar_System_fputs MMC_REFSTRUCTLIT(boxvar_lit_System_fputs)

extern int SystemImpl__fputs(const char* /*_str*/, int /*_streamType*/);
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_alarmExpired,2,0) {(void*) boxptr_System_alarmExpired,0}};
#define boxvar_System_alarmExpired MMC_REFSTRUCTLIT(boxvar_lit_System_alarmExpired)
...
DLLModelDirection
modelica_string omc_System_openModelicaPlatformAlternative(threadData_t *threadData);
#define boxptr_System_openModelicaPlatformAlternative omc_System_openModelicaPlatformAlternative
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_openModelicaPlatformAlternative,2,0) {(void*) boxptr_System_openModelicaPlatformAlternative,0}};
#define boxvar_System_openModelicaPlatformAlternative MMC_REFSTRUCTLIT(boxvar_lit_System_openModelicaPlatformAlternative)
...
DLLModelDirection
modelica_real omc_System_realtimeAccumulated(threadData_t *threadData, modelica_integer _clockIndex);
DLLModelDirection
modelica_metatype boxptr_System_realtimeAccumulated(threadData_t *threadData, modelica_metatype _clockIndex);
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_realtimeAccumulated,2,0) {(void*) boxptr_System_realtimeAccumulated,0}};
#define boxvar_System_realtimeAccumulated MMC_REFSTRUCTLIT(boxvar_lit_System_realtimeAccumulated)

extern double System_realtimeAccumulated(int /*_clockIndex*/);

DLLModelDirection
modelica_real omc_System_realtimeAccumulate(threadData_t *threadData, modelica_integer _clockIndex);
DLLModelDirection
modelica_metatype boxptr_System_realtimeAccumulate(threadData_t *threadData, modelica_metatype _clockIndex);
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_realtimeAccumulate,2,0) {(void*) boxptr_System_realtimeAccumulate,0}};
#define boxvar_System_realtimeAccumulate MMC_REFSTRUCTLIT(boxvar_lit_System_realtimeAccumulate)

extern double System_realtimeAccumulate(int /*_clockIndex*/);
...
#define boxptr_System_winGetSystemDirectoryA omc_System_winGetSystemDirectoryA

extern const char* SystemImpl__winGetSystemDirectoryA();

DLLModelDirection
modelica_string omc_System_winGetSystemDirectory(threadData_t *threadData);
#define boxptr_System_winGetSystemDirectory omc_System_winGetSystemDirectory
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_winGetSystemDirectory,2,0) {(void*) boxptr_System_winGetSystemDirectory,0}};
#define boxvar_System_winGetSystemDirectory MMC_REFSTRUCTLIT(boxvar_lit_System_winGetSystemDirectory)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_systemCallRestrictedEnv,2,0) {(void*) boxptr_System_systemCallRestrictedEnv,0}};
#define boxvar_System_systemCallRestrictedEnv MMC_REFSTRUCTLIT(boxvar_lit_System_systemCallRestrictedEnv)
...
DLLModelDirection
modelica_metatype omc_System_splitOnNewline(threadData_t *threadData, modelica_string _str, modelica_boolean _includeDelimiter);
DLLModelDirection
modelica_metatype boxptr_System_splitOnNewline(threadData_t *threadData, modelica_metatype _str, modelica_metatype _includeDelimiter);
static const MMC_DEFSTRUCTLIT(boxvar_lit_System_splitOnNewline,2,0) {(void*) boxptr_System_splitOnNewline,0}};
#define boxvar_System_splitOnNewline MMC_REFSTRUCTLIT(boxvar_lit_System_splitOnNewline)

extern modelica_metatype System_splitOnNewline(const char* /*_str*/, int /*_includeDelimiter*/);
