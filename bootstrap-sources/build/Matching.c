...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT53,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(50)),_OMC_LIT51,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT52}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT79,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(121)),_OMC_LIT75,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT76,_OMC_LIT77,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT78}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT84,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(115)),_OMC_LIT82,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT83}};
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT122_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT124_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT150_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT168_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT177_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT179_6,0.0);
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT195_6,0.0);
...
modelica_metatype omc_Matching_incomingEquations(threadData_t *threadData, modelica_integer _eqn, modelica_metatype _m, modelica_metatype _ass1)
{
  ...
  // _outEqNodes has no default value.
  {
    ...
    while(1) {
      ...
      if (tmp4 == 0) {
        __omcQ_24tmpVar4 = arrayGet(_ass1,mmc_unbox_integer(_var)) /* DAE.ASUB */;
