...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_CevalFunction_isElementEqual(threadData_t *threadData, modelica_metatype _inElement1, modelica_metatype _inElement2)
{
  ...
  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta5,0,14) == 0) MMC_THROW_INTERNAL();
    ...
    tmp4_1 = _inElement;
    {
      ...
      for (; tmp4 < 1; tmp4++) {
        ...
        case 0: {
          ...
          tmpMeta22 = mmc_mk_box15(3, &DAE_Element_VAR__desc, _cref, _vk, _vd, _vp, _vv, _ty, _bind, _dims, _ct, _es, _va, _cmt, _io, mmc_mk_boolean(_e));
          tmpMeta1 = tmpMeta22;
          goto tmp3_done;
        }
        }
