...
modelica_string omc_SBMultiInterval_toString(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  {
    omc_string_store(&(_str), _OMC_LIT1);
  }
  else
  {
    {
      ...
      _i_loopVar = (OMC_BOX_FIELD(_mi, 2));
      tmp5 = 1;
    ...
    omc_string_store(&(_str), stringDelimitList(tmpMeta1, _OMC_LIT0));
  }
...
modelica_integer omc_SBMultiInterval_size(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  {
    modelica_metatype _i;
    for (tmpMeta1 = (OMC_BOX_FIELD(_mi, 2)), tmp4 = arrayLength(tmpMeta1), tmp3 = 1; tmp3 <= tmp4; tmp3++)
    {
...
modelica_integer omc_SBMultiInterval_hash(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  _res = arrayLength((OMC_BOX_FIELD(_mi, 2)));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _res;
  return omc_ret_;
}
...
modelica_boolean omc_SBMultiInterval_isEqual(threadData_t *threadData, modelica_metatype _mi1, modelica_metatype _mi2)
{
  ...
  _equal = omc_Array_isEqualOnTrue(threadData, (OMC_BOX_FIELD(_mi1, 2)), (OMC_BOX_FIELD(_mi2, 2)), boxvar_SBInterval_isEqual);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _equal;
  return omc_ret_;
}
...
modelica_metatype omc_SBMultiInterval_replace(threadData_t *threadData, modelica_metatype _i, modelica_integer _dim, modelica_metatype _mi)
{
  ...
  _ints = arrayCopy((OMC_BOX_FIELD(_mi, 2)));
...
modelica_metatype omc_SBMultiInterval_minElem(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  {
    modelica_metatype _i;
    for (tmpMeta1 = (OMC_BOX_FIELD(_mi, 2)), tmp5 = arrayLength(tmpMeta1), tmp4 = 1; tmp4 <= tmp5; tmp4++)
    {
  ...
  _res = omc_Array_map(threadData, (OMC_BOX_FIELD(_mi, 2)), boxvar_SBInterval_lowerBound);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _res;
  return omc_ret_;
}
...
modelica_integer omc_SBMultiInterval_ndim(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _ndim = arrayLength((OMC_BOX_FIELD(_mi, 2)));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _ndim;
  return omc_ret_;
}
...
modelica_integer omc_SBMultiInterval_cardinality(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  tmp1 = ((modelica_integer) 1); tmp2 = 1; tmp3 = omc_unbox_integer((OMC_BOX_FIELD(_mi, 3)));
  if(!(((tmp2 > 0) && (tmp1 > tmp3)) || ((tmp2 < 0) && (tmp1 < tmp3))))
  {
    ...
    for(_i = ((modelica_integer) 1); in_range_integer(_i, tmp1, tmp3); _i += tmp2)
    {
      ...
      _card = _card + omc_SBInterval_cardinality(threadData, arrayGet((OMC_BOX_FIELD(_mi, 2)),_i) /* DAE.ASUB */);
    }
  }
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _card;
...
modelica_metatype omc_SBMultiInterval_crossProd(threadData_t *threadData, modelica_metatype _mi1, modelica_metatype _mi2)
{
  ...
  // _res has no default value.
  // _ints has no default value.
  _ints = omc_Array_join(threadData, (OMC_BOX_FIELD(_mi1, 2)), (OMC_BOX_FIELD(_mi2, 2)));

  tmpMeta1 = omc_mk_box3(3, &SBMultiInterval_MULTI__INTERVAL__desc, _ints, omc_mk_integer(arrayLength(_ints)));
  _res = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _res;
  return omc_ret_;
...
{
  modelica_metatype count = OMC_BOX_FIELD(closure, 1);
  modelica_metatype size = OMC_BOX_FIELD(closure, 2);
  modelica_metatype ints1 = OMC_BOX_FIELD(closure, 3);
  modelica_metatype ints2 = OMC_BOX_FIELD(closure, 4);
...
modelica_metatype omc_SBMultiInterval_complement(threadData_t *threadData, modelica_metatype _mi1, modelica_metatype _mi2)
{
  ...
  if((omc_SBMultiInterval_isEmpty(threadData, _mi1) || (omc_unbox_integer((OMC_BOX_FIELD(_mi1, 3))) != omc_unbox_integer((OMC_BOX_FIELD(_mi2, 3))))))
  {
    goto _return;
  }
  ...
  _mi1_size = arrayLength((OMC_BOX_FIELD(_mi1, 2)));
  ...
  if(!(((tmp2 > 0) && (tmp1 > tmp3)) || ((tmp2 < 0) && (tmp1 < tmp3))))
  {
    ...
    for(_i = ((modelica_integer) 1); in_range_integer(_i, tmp1, tmp3); _i += tmp2)
    {
      ...
      arrayUpdate(_diffs,_i,omc_SBInterval_complement(threadData, arrayGetNoBoundsChecking((OMC_BOX_FIELD(_mi1, 2)), _i), arrayGet((OMC_BOX_FIELD(_tmp_mi, 2)), _i)));
    }
  }
...

  {
    ...
    for (tmpMeta4 = _diffs, tmp8 = arrayLength(tmpMeta4), tmp7 = 1; tmp7 <= tmp8; tmp7++)
    {
      ...
      tmpMeta5 = omc_mk_box4(0, omc_mk_integer(_count), omc_mk_integer(_mi1_size), (OMC_BOX_FIELD(_tmp_mi, 2)), (OMC_BOX_FIELD(_mi1, 2)));
      omc_UnorderedSet_fold(threadData, _vdiff, (modelica_fnptr) omc_mk_box2(0,closure0_SBMultiInterval_complement_add__interval,tmpMeta5), _res);
...
modelica_metatype omc_SBMultiInterval_intersection(threadData_t *threadData, modelica_metatype _mi1, modelica_metatype _mi2)
{
  ...
  if(((omc_unbox_integer((OMC_BOX_FIELD(_mi1, 3))) != omc_unbox_integer((OMC_BOX_FIELD(_mi2, 3)))) || omc_SBMultiInterval_isEmpty(threadData, _mi1)))
  {
  ...
  _ints = arrayCreateNoInit(omc_unbox_integer((OMC_BOX_FIELD(_mi1, 3))), arrayGet((OMC_BOX_FIELD(_mi1, 2)), ((modelica_integer) 1)));
  ...
  if(!(((tmp2 > 0) && (tmp1 > tmp3)) || ((tmp2 < 0) && (tmp1 < tmp3))))
  {
    ...
    for(_i = ((modelica_integer) 1); in_range_integer(_i, tmp1, tmp3); _i += tmp2)
    {
      ...
      _ires = omc_SBInterval_intersection(threadData, arrayGet((OMC_BOX_FIELD(_mi1, 2)), _i), arrayGet((OMC_BOX_FIELD(_mi2, 2)), _i));
...
modelica_boolean omc_SBMultiInterval_contains(threadData_t *threadData, modelica_metatype _vals, modelica_metatype _mi)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _res has no default value.
  if((arrayLength(_vals) != omc_unbox_integer((OMC_BOX_FIELD(_mi, 3)))))
  {
    _res = 0 /* false */;
  }
  else
  {
    _res = omc_Array_isEqualOnTrue(threadData, _vals, (OMC_BOX_FIELD(_mi, 2)), boxvar_SBInterval_contains);
  }
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _res;
  return omc_ret_;
...
modelica_boolean omc_SBMultiInterval_isEmpty(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  _empty = (arrayLength((OMC_BOX_FIELD(_mi, 2))) == ((modelica_integer) 0));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _empty;
  return omc_ret_;
}
...
modelica_metatype omc_SBMultiInterval_fromArray(threadData_t *threadData, modelica_metatype _ints)
{
  ...
  {
    tmpMeta1 = omc_mk_box3(3, &SBMultiInterval_MULTI__INTERVAL__desc, arrayCopy(_ints), omc_mk_integer(arrayLength(_ints)));
    _outMI = tmpMeta1;
  }
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outMI;
...
modelica_metatype omc_SBMultiInterval_fromList(threadData_t *threadData, modelica_metatype _ints)
{
  ...
  {
    tmpMeta1 = omc_mk_box3(3, &SBMultiInterval_MULTI__INTERVAL__desc, listArray(_ints), omc_mk_integer(listLength(_ints)));
    _outMI = tmpMeta1;
  }
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outMI;
...
modelica_metatype omc_SBMultiInterval_copy(threadData_t *threadData, modelica_metatype _mi)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _outMI has no default value.
  tmpMeta1 = omc_mk_box3(3, &SBMultiInterval_MULTI__INTERVAL__desc, arrayCopy((OMC_BOX_FIELD(_mi, 2))), (OMC_BOX_FIELD(_mi, 3)));
  _outMI = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outMI;
  return omc_ret_;
...
modelica_metatype omc_SBMultiInterval_newEmpty(threadData_t *threadData)
{
  ...
  tmpMeta2 = omc_mk_box3(3, &SBMultiInterval_MULTI__INTERVAL__desc, listArray(tmpMeta1), omc_mk_integer(((modelica_integer) 0)));
  _mi = tmpMeta2;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _mi;
  return omc_ret_;
