...
modelica_metatype omc_Lapack_dhseqr(threadData_t *threadData, modelica_string _inJOB, modelica_string _inCOMPZ, modelica_integer _inN, modelica_integer _inILO, modelica_integer _inIHI, modelica_metatype _inH, modelica_integer _inLDH, modelica_metatype _inZ, modelica_integer _inLDZ, modelica_metatype _inWORK, modelica_integer _inLWORK, modelica_metatype *out_outWR, modelica_metatype *out_outWI, modelica_metatype *out_outZ, modelica_metatype *out_outWORK, modelica_integer *out_outINFO)
{
  int _inN_ext;
  int _inILO_ext;
  int _inIHI_ext;
  modelica_metatype _inH_ext;
  int _inLDH_ext;
  modelica_metatype _inZ_ext;
  int _inLDZ_ext;
  modelica_metatype _inWORK_ext;
  int _inLWORK_ext;
  modelica_metatype _outH_ext;
  modelica_metatype _outWR_ext;
  modelica_metatype _outWI_ext;
  modelica_metatype _outZ_ext;
  modelica_metatype _outWORK_ext;
  int _outINFO_ext;
  modelica_metatype _outH = NULL;
  modelica_metatype _outWR = NULL;
  modelica_metatype _outWI = NULL;
  modelica_metatype _outZ = NULL;
  modelica_metatype _outWORK = NULL;
  modelica_integer _outINFO;
  // _outH has no default value.
  // _outWR has no default value.
  // _outWI has no default value.
  ...
  _outZ = (modelica_metatype)_outZ_ext;
  ...
  if (out_outZ) { *out_outZ = _outZ; }
  if (out_outWORK) { *out_outWORK = _outWORK; }
  if (out_outINFO) { *out_outINFO = _outINFO; }
  return _outH;
}
modelica_metatype boxptr_Lapack_dhseqr(threadData_t *threadData, modelica_metatype _inJOB, modelica_metatype _inCOMPZ, modelica_metatype _inN, modelica_metatype _inILO, modelica_metatype _inIHI, modelica_metatype _inH, modelica_metatype _inLDH, modelica_metatype _inZ, modelica_metatype _inLDZ, modelica_metatype _inWORK, modelica_metatype _inLWORK, modelica_metatype *out_outWR, modelica_metatype *out_outWI, modelica_metatype *out_outZ, modelica_metatype *out_outWORK, modelica_metatype *out_outINFO)
{
...
modelica_metatype omc_Lapack_dgtsv(threadData_t *threadData, modelica_integer _inN, modelica_integer _inNRHS, modelica_metatype _inDL, modelica_metatype _inD, modelica_metatype _inDU, modelica_metatype _inB, modelica_integer _inLDB, modelica_metatype *out_outD, modelica_metatype *out_outDU, modelica_metatype *out_outB, modelica_integer *out_outINFO)
{
  ...
  modelica_metatype _outB = NULL;
  modelica_integer _outINFO;
  // _outDL has no default value.
  // _outD has no default value.
...
modelica_metatype omc_Lapack_dgegv(threadData_t *threadData, modelica_string _inJOBVL, modelica_string _inJOBVR, modelica_integer _inN, modelica_metatype _inA, modelica_integer _inLDA, modelica_metatype _inB, modelica_integer _inLDB, modelica_integer _inLDVL, modelica_integer _inLDVR, modelica_metatype _inWORK, modelica_integer _inLWORK, modelica_metatype *out_outALPHAI, modelica_metatype *out_outBETA, modelica_metatype *out_outVL, modelica_metatype *out_outVR, modelica_metatype *out_outWORK, modelica_integer *out_outINFO)
{
  ...
  modelica_metatype _outWORK = NULL;
  modelica_integer _outINFO;
  // _outALPHAR has no default value.
  // _outALPHAI has no default value.
  // _outBETA has no default value.
  // _outVL has no default value.
