...
{
  modelica_fnptr fun = OMC_BOX_FIELD(closure, 1);
...
modelica_metatype omc_NBEvaluation_removeDummyComponents(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fpart)
{
  ...
  tmpMeta2 = omc_mk_box1(0, boxvar_NBStrongComponent_isDummy);
  tmpMeta1 = MMC_TAGPTR(mmc_alloc_words(10));
  memcpy(MMC_UNTAGPTR(tmpMeta1), MMC_UNTAGPTR(_part), 10*sizeof(modelica_metatype));
  ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta1))[9] = omc_Util_applyOption(threadData, (OMC_BOX_FIELD(_part, 9)), (modelica_fnptr) omc_mk_box2(0,closure0_Array_filter,tmpMeta2));
  _part = tmpMeta1;
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            _p_loopVar = (OMC_BOX_FIELD(_bdae, 2));
...

          {
            ...
            modelica_metatype _p_loopVar = 0;
            modelica_metatype _p;
            _p_loopVar = (OMC_BOX_FIELD(_bdae, 3));
...

          {
            ...
            modelica_metatype _p_loopVar = 0;
            modelica_metatype _p;
            _p_loopVar = (OMC_BOX_FIELD(_bdae, 4));
...

          {
            ...
            modelica_metatype _p_loopVar = 0;
            modelica_metatype _p;
            _p_loopVar = (OMC_BOX_FIELD(_bdae, 5));
            ...
            while(1) {
              ...
              if (tmp25 == 0) {
                __omcQ_24tmpVar8 = omc_NBEvaluation_removeDummyComponents(threadData, _p);
...
modelica_metatype omc_NBEvaluation_Stages_convert(threadData_t *threadData, modelica_metatype _stages)
{
  ...
  tmpMeta1 = omc_mk_box5(3, &BackendDAE_EvaluationStages_EVALUATION__STAGES__desc, (OMC_BOX_FIELD(_stages, 2)), (OMC_BOX_FIELD(_stages, 3)), (OMC_BOX_FIELD(_stages, 4)), (OMC_BOX_FIELD(_stages, 5)));
  _oldEvalStages = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _oldEvalStages;
  return omc_ret_;
}
