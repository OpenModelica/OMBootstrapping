...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT6,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(65)),_OMC_LIT4,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT5}};
    ...
    tmp4_1 = _inProgram;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          tmp7 = stringAppend(_OMC_LIT7,omc_AbsynUtil_pathString(threadData, _inClassName, _OMC_LIT8, 1 /* true */, 0 /* false */));
