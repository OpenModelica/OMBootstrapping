...
DLLModelDirection
modelica_boolean omc_NFCall_itersContainExp(threadData_t *threadData, modelica_metatype _iters, modelica_fnptr _func);
DLLModelDirection
modelica_metatype boxptr_NFCall_itersContainExp(threadData_t *threadData, modelica_metatype _iters, modelica_fnptr _func);
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFCall_itersContainExp,2,0) {(void*) boxptr_NFCall_itersContainExp,0}};
#define boxvar_NFCall_itersContainExp MMC_REFSTRUCTLIT(boxvar_lit_NFCall_itersContainExp)
...
DLLModelDirection
modelica_boolean omc_NFCall_isUnboxableType(threadData_t *threadData, modelica_metatype _ty);
DLLModelDirection
modelica_metatype boxptr_NFCall_isUnboxableType(threadData_t *threadData, modelica_metatype _ty);
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFCall_isUnboxableType,2,0) {(void*) boxptr_NFCall_isUnboxableType,0}};
#define boxvar_NFCall_isUnboxableType MMC_REFSTRUCTLIT(boxvar_lit_NFCall_isUnboxableType)
