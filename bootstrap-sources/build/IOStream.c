...
void omc_IOStream_print(threadData_t *threadData, modelica_metatype _inStream, modelica_integer _whereToPrint)
{
  ...
  { /* match expression */
    ...
    tmp3_1 = _inStream;
    {
      ...
      int tmp4;
      // _listData has no default value.
      ...
      for (; tmp3 < 3; tmp3++) {
        ...
        case 0: {
          ...
          _fileID = tmp7  /* pattern as ty=Integer */;
        ...
        case 1: {
          ...
          _bufferID = tmp10  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
...
void boxptr_IOStream_print(threadData_t *threadData, modelica_metatype _inStream, modelica_metatype _whereToPrint)
{
  ...
  tmp1 = omc_unbox_integer(_whereToPrint);
    ...
    tmp4_1 = _inStream;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _fileID = tmp8  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
        ...
        case 2: {
          ...
          _bufferID = tmp13  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
...
modelica_boolean omc_IOStream_empty(threadData_t *threadData, modelica_metatype _inStream)
{
  ...
  _data = (OMC_BOX_FIELD(_inStream, 4));
  { /* match expression */
    modelica_metatype tmp4_1;
    tmp4_1 = _data;
    {
      ...
      for (; tmp4 < 1; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = listEmpty((OMC_BOX_FIELD(_data, 2)));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
...
modelica_metatype boxptr_IOStream_empty(threadData_t *threadData, modelica_metatype _inStream)
{
  ...
  _res = omc_IOStream_empty(threadData, _inStream);
    ...
    tmp4_1 = _inStream;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 1: {
          ...
          _ty = tmpMeta10;
          /* Pattern matching succeeded */
          tmpMeta11 = omc_mk_box4(3, &IOStream_IOStream_IOSTREAM__desc, _name, _ty, _OMC_LIT0);
          tmpMeta1 = tmpMeta11;
          goto tmp3_done;
        }
        case 2: {
          ...
          _bStream = tmp4_1;
          _bufferID = tmp14  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
    ...
    tmp3_1 = _inStream;
    {
      ...
      for (; tmp3 < 3; tmp3++) {
        ...
        case 2: {
          ...
          _bufferID = tmp11  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
...
{
  modelica_metatype _dstStream = NULL;
  modelica_metatype _data = NULL;
  modelica_metatype tmpMeta1;
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _dstStream = __omcQ_24in_5FdstStream;
  ...
  _dstStream = omc_IOStream_appendListReverse(threadData, _dstStream, _data);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _dstStream;
  return omc_ret_;
}
...
modelica_metatype omc_IOStream_appendListReverse(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fs, modelica_metatype _data)
{
  ...
  modelica_metatype _s_data = NULL;
  modelica_metatype omc_ret_;
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _s = __omcQ_24in_5Fs;
  _s_data = (OMC_BOX_FIELD(_s, 4));
  { /* match expression */
    modelica_metatype tmp3_1;
    tmp3_1 = _s_data;
    {
      int tmp3;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            for (tmpMeta4 = _data; !listEmpty(tmpMeta4); tmpMeta4=MMC_CDR(tmpMeta4))
            {
              _str = MMC_CAR(tmpMeta4);
              omc_IOStreamExt_appendFile(threadData, omc_unbox_integer((OMC_BOX_FIELD(_s_data, 2))), _str);
            }
          }
          goto tmp2_done;
        }
        case 4: {
          ...
          memcpy(MMC_UNTAGPTR(tmpMeta6), MMC_UNTAGPTR(_s_data), 3*sizeof(modelica_metatype));
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[2] = listAppend(_data, (OMC_BOX_FIELD(_s_data, 2)));
          _s_data = tmpMeta6;

          tmpMeta7 = MMC_TAGPTR(mmc_alloc_words(5));
          memcpy(MMC_UNTAGPTR(tmpMeta7), MMC_UNTAGPTR(_s), 5*sizeof(modelica_metatype));
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta7))[4] = _s_data;
          _s = tmpMeta7;
          goto tmp2_done;
        }
        case 5: {
          ...
          {
            modelica_metatype _str;
            for (tmpMeta8 = _data; !listEmpty(tmpMeta8); tmpMeta8=MMC_CDR(tmpMeta8))
            {
              _str = MMC_CAR(tmpMeta8);
              omc_IOStreamExt_appendBuffer(threadData, omc_unbox_integer((OMC_BOX_FIELD(_s_data, 2))), _str);
            }
          }
          goto tmp2_done;
        }
...
modelica_metatype omc_IOStream_append(threadData_t *threadData, modelica_metatype _inStream, modelica_string _inString)
{
  ...
  { /* match expression */
    ...
    tmp4_1 = _inStream;
    {
      ...
      // _fStream has no default value.
      // _bStream has no default value.
      // _streamName has no default value.
      // _streamType has no default value.
      tmp4 = 0;
      for (; tmp4 < 3; tmp4++) {
        switch (MMC_SWITCH_CAST(tmp4)) {
        case 0: {
        ...
        case 1: {
          ...
          tmpMeta14 = omc_mk_box2(4, &IOStream_IOStreamData_LIST__DATA__desc, tmpMeta13);
          tmpMeta15 = omc_mk_box4(3, &IOStream_IOStream_IOSTREAM__desc, _streamName, _streamType, tmpMeta14);
          tmpMeta1 = tmpMeta15;
          goto tmp3_done;
        }
        case 2: {
          ...
          _bStream = tmp4_1;
          _bufferID = tmp18  /* pattern as ty=Integer */;
          /* Pattern matching succeeded */
    ...
    tmp4_1 = _streamType;
    {
      ...
      // _bufferID has no default value.
      {
        ...
        case 3: {
          ...
          tmpMeta6 = omc_mk_box2(3, &IOStream_IOStreamData_FILE__DATA__desc, omc_mk_integer(_fileID));
          tmpMeta7 = omc_mk_box4(3, &IOStream_IOStream_IOSTREAM__desc, _streamName, _streamType, tmpMeta6);
          tmpMeta1 = tmpMeta7;
          goto tmp3_done;
        }
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta8 = omc_mk_box4(3, &IOStream_IOStream_IOSTREAM__desc, _streamName, _streamType, _OMC_LIT0);
          tmpMeta1 = tmpMeta8;
          goto tmp3_done;
        }
        case 5: {
          ...
          tmpMeta9 = omc_mk_box2(5, &IOStream_IOStreamData_BUFFER__DATA__desc, omc_mk_integer(_bufferID));
          tmpMeta10 = omc_mk_box4(3, &IOStream_IOStream_IOSTREAM__desc, _streamName, _streamType, tmpMeta9);
          tmpMeta1 = tmpMeta10;
          goto tmp3_done;
        }
        }
