...
#define _OMC_LIT57_data "NBPartitioning.mo"
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT79,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(103)),_OMC_LIT77,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),_OMC_LIT78}};
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT100_6,0.0);
                ...
                case 0: {
                  ...
                  /* Pattern matching succeeded */
                  {
                    ...
                    while(1) {
                      ...
                      if (tmp43 == 0) {
                        __omcQ_24tmpVar26 = omc_NBVariable_getVarName(threadData, _var);
...
modelica_integer omc_NBPartitioning_DisjointSetForest_unite(threadData_t *threadData, modelica_metatype _dsf, modelica_metatype _indices)
{
  ...
  // _root has no default value.
  {
    ...
    while(1) {
      ...
      if (tmp4 == 0) {
        __omcQ_24tmpVar50 = mmc_mk_integer(omc_NBPartitioning_DisjointSetForest_find(threadData, _dsf, mmc_unbox_integer(_i)));
...
modelica_metatype omc_NBPartitioning_Cluster_toPartition(threadData_t *threadData, modelica_metatype _cluster, modelica_metatype _variables, modelica_metatype _equations, modelica_integer _kind, modelica_metatype _info, modelica_metatype _held_crefs, modelica_metatype _infer_del)
{
  ...
  _inferred_clocks = omc_UnorderedSet_new(threadData, boxvar_NFComponentRef_hash, boxvar_NFComponentRef_isEqual, ((modelica_integer) 13));
  {
    ...
    while(1) {
      ...
      if (tmp4 == 0) {
        __omcQ_24tmpVar54 = omc_NBVariable_getVarPointer(threadData, _cref, _OMC_LIT80);
