...
#define boxptr_AvlSetString_smallestKey omc_AvlSetString_smallestKey
static const MMC_DEFSTRUCTLIT(boxvar_lit_AvlSetString_smallestKey,2,0) {(void*) boxptr_AvlSetString_smallestKey,0}};
#define boxvar_AvlSetString_smallestKey MMC_REFSTRUCTLIT(boxvar_lit_AvlSetString_smallestKey)
