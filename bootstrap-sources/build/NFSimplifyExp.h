...
DLLModelDirection
modelica_metatype omc_NFSimplifyExp_chainBinaries(threadData_t *threadData, modelica_metatype _args, modelica_metatype _op);
#define boxptr_NFSimplifyExp_chainBinaries omc_NFSimplifyExp_chainBinaries
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFSimplifyExp_chainBinaries,2,0) {(void*) boxptr_NFSimplifyExp_chainBinaries,0}};
#define boxvar_NFSimplifyExp_chainBinaries MMC_REFSTRUCTLIT(boxvar_lit_NFSimplifyExp_chainBinaries)
