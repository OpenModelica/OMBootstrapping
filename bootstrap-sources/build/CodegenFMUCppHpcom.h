#ifndef CodegenFMUCppHpcom__H
#define CodegenFMUCppHpcom__H
...
#define boxvar_CodegenFMUCppHpcom_translateModel MMC_REFSTRUCTLIT(boxvar_lit_CodegenFMUCppHpcom_translateModel)
