    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          _right = tmpMeta6;
          /* Pattern matching succeeded */
          tmpMeta7 = stringAppend(omc_AvlSetString_printTreeStr2(threadData, _left, 1 /* true */, _OMC_LIT2),omc_AvlSetString_printNodeStr(threadData, _inTree));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT3);
          tmpMeta9 = stringAppend(tmpMeta8,omc_AvlSetString_printTreeStr2(threadData, _right, 0 /* false */, _OMC_LIT2));
          tmp1 = tmpMeta9;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _inTree;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          tmpMeta6 = stringAppend(omc_AvlSetString_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 4))), 1 /* true */, tmpMeta5),_inIndent);
          tmpMeta7 = stringAppend(tmpMeta6,(_isLeft?_OMC_LIT6:_OMC_LIT7));
          tmpMeta8 = stringAppend(tmpMeta7,_OMC_LIT8);
          tmpMeta9 = stringAppend(tmpMeta8,omc_AvlSetString_printNodeStr(threadData, _inTree));
          tmpMeta10 = stringAppend(tmpMeta9,_OMC_LIT3);
          tmpMeta11 = stringAppend(_inIndent,(_isLeft?_OMC_LIT5:_OMC_LIT4));
          tmpMeta12 = stringAppend(tmpMeta10,omc_AvlSetString_printTreeStr2(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inTree), 5))), 0 /* false */, tmpMeta11));
          tmp1 = tmpMeta12;
          goto tmp3_done;
        }
        case 4: {
          ...
          tmpMeta15 = stringAppend(tmpMeta14,omc_AvlSetString_printNodeStr(threadData, _inTree));
