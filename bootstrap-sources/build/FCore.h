...
#define boxptr_FCore_RefTree_smallestKey omc_FCore_RefTree_smallestKey
static const MMC_DEFSTRUCTLIT(boxvar_lit_FCore_RefTree_smallestKey,2,0) {(void*) boxptr_FCore_RefTree_smallestKey,0}};
#define boxvar_FCore_RefTree_smallestKey MMC_REFSTRUCTLIT(boxvar_lit_FCore_RefTree_smallestKey)
