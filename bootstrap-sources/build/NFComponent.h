...
static const MMC_DEFSTRUCTLIT(boxvar_lit_NFComponent_isIterator,2,0) {(void*) boxptr_NFComponent_isIterator,0}};
#define boxvar_NFComponent_isIterator MMC_REFSTRUCTLIT(boxvar_lit_NFComponent_isIterator)
