...
#define _OMC_LIT28_data "BackendVariable.mo"
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT64,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(174)),_OMC_LIT62,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT63}};
