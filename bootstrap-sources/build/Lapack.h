...
static const MMC_DEFSTRUCTLIT(boxvar_lit_Lapack_dhseqr,2,0) {(void*) boxptr_Lapack_dhseqr,0}};
#define boxvar_Lapack_dhseqr MMC_REFSTRUCTLIT(boxvar_lit_Lapack_dhseqr)

extern void LapackImpl__dhseqr(const char* /*_inJOB*/, const char* /*_inCOMPZ*/, int /*_inN*/, int /*_inILO*/, int /*_inIHI*/, modelica_metatype /*_inH*/, int /*_inLDH*/, modelica_metatype /*_inZ*/, int /*_inLDZ*/, modelica_metatype /*_inWORK*/, int /*_inLWORK*/, modelica_metatype* /*_outH*/, modelica_metatype* /*_outWR*/, modelica_metatype* /*_outWI*/, modelica_metatype* /*_outZ*/, modelica_metatype* /*_outWORK*/, int* /*_outINFO*/);
