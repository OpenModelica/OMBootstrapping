...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_UnorderedSet_extractFromLst(threadData_t *threadData, modelica_metatype _lst, modelica_fnptr _func, modelica_metatype *out_rest)
{
  ...
  _size = omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_single, 3))));

  {
    ...
    for (tmpMeta5 = _tmp_lst; !listEmpty(tmpMeta5); tmpMeta5=MMC_CDR(tmpMeta5))
    {
      ...
      if(omc_unbox_boolean((OMC_BOX_FIELD(_func, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_func, 1))) (threadData, (OMC_BOX_FIELD(_func, 2)), omc_Mutable_access(threadData, (OMC_BOX_FIELD(_tmp, 3))), omc_mk_integer(_size)) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_func, 1))) (threadData, omc_Mutable_access(threadData, (OMC_BOX_FIELD(_tmp, 3))), omc_mk_integer(_size))))
      {
        _size = omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_tmp, 3))));
...
PROTECTED_FUNCTION_STATIC void omc_UnorderedSet_addKey(threadData_t *threadData, modelica_metatype _key, modelica_integer _hash, modelica_metatype _set)
{
  ...
  if((omc_UnorderedSet_loadFactor(threadData, _set) > 1.0))
  {
    ...
    _hashfn = (modelica_fnptr) (OMC_BOX_FIELD(_set, 4));

    _buckets = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2)));

    _h = modelica_integer_mod(omc_unbox_integer((OMC_BOX_FIELD(_hashfn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, (OMC_BOX_FIELD(_hashfn, 2)), _key) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, _key)), arrayLength(_buckets));
  }
  else
  {
    _buckets = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2)));
  ...
  omc_Mutable_update(threadData, (OMC_BOX_FIELD(_set, 3)), omc_mk_integer(((modelica_integer) 1) + (omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3)))))));
  _return: OMC_LABEL_UNUSED
  return;
}
PROTECTED_FUNCTION_STATIC void boxptr_UnorderedSet_addKey(threadData_t *threadData, modelica_metatype _key, modelica_metatype _hash, modelica_metatype _set)
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_UnorderedSet_find(threadData_t *threadData, modelica_metatype _key, modelica_metatype _set, modelica_integer *out_hash)
{
  ...
  _hashfn = (OMC_BOX_FIELD(_set, 4));
  _eqfn = (OMC_BOX_FIELD(_set, 5));
  _buckets = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2)));
...

  {
    ...
    {
      _k = MMC_CAR(tmpMeta1);
      if(omc_unbox_boolean((OMC_BOX_FIELD(_eqfn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_eqfn, 1))) (threadData, (OMC_BOX_FIELD(_eqfn, 2)), _k, _key) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_eqfn, 1))) (threadData, _k, _key)))
      {
...
modelica_boolean omc_UnorderedSet_isDisjoint(threadData_t *threadData, modelica_metatype _set1, modelica_metatype _set2)
{
  ...
  if((omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set1, 3)))) > omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set2, 3))))))
  {
    _set_small = _set2;
  ...
  {
    {
      ...
      for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set_small, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
      {
...
modelica_metatype omc_UnorderedSet_sym__difference(threadData_t *threadData, modelica_metatype _set1, modelica_metatype _set2)
{
  ...
  {
    {
      ...
      for (tmpMeta2 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set1, 2))), tmp8 = arrayLength(tmpMeta2), tmp7 = 1; tmp7 <= tmp8; tmp7++)
      {
  ...
  if((!omc_UnorderedSet_isEmpty(threadData, _set2)))
  {
    {
      modelica_metatype _b;
      for (tmpMeta9 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set2, 2))), tmp15 = arrayLength(tmpMeta9), tmp14 = 1; tmp14 <= tmp15; tmp14++)
      {
  ...
  _set = omc_UnorderedSet_fromList(threadData, _acc, (OMC_BOX_FIELD(_set1, 4)), (OMC_BOX_FIELD(_set1, 5)));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _set;
  return omc_ret_;
}
...
modelica_metatype omc_UnorderedSet_difference__list(threadData_t *threadData, modelica_metatype _inList1, modelica_metatype _inList2, modelica_fnptr _hashFunc, modelica_fnptr _keyEqFunc)
{
  ...
  while(1)
  {
    if(!((!(listEmpty(_lst1) || listEmpty(_lst2))) && omc_unbox_boolean((OMC_BOX_FIELD(_keyEqFunc, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_keyEqFunc, 1))) (threadData, (OMC_BOX_FIELD(_keyEqFunc, 2)), listHead(_lst1), listHead(_lst2)) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_keyEqFunc, 1))) (threadData, listHead(_lst1), listHead(_lst2))))) break;
...
modelica_metatype omc_UnorderedSet_intersection__list(threadData_t *threadData, modelica_metatype _set_lst, modelica_fnptr _hashFunc, modelica_fnptr _keyEqFunc)
{
  ...
  if((!listEmpty(_set_lst)))
  {
    ...
    {
      modelica_metatype _b;
      for (tmpMeta2 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set_small, 2))), tmp9 = arrayLength(tmpMeta2), tmp8 = 1; tmp8 <= tmp9; tmp8++)
      {
        _b = arrayGet(tmpMeta2,tmp8);
        {
          ...
          {
            _k = MMC_CAR(tmpMeta3);
            tmpMeta4 = omc_mk_box1(0, _k);
            if(omc_List_all(threadData, _rest, (modelica_fnptr) omc_mk_box2(0,closure0_UnorderedSet_contains,tmpMeta4)))
            {
...
modelica_metatype omc_UnorderedSet_intersection(threadData_t *threadData, modelica_metatype _set1, modelica_metatype _set2)
{
  ...
  if((!omc_UnorderedSet_isEmpty(threadData, _set_small)))
  {
    {
      modelica_metatype _b;
      for (tmpMeta2 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set_small, 2))), tmp8 = arrayLength(tmpMeta2), tmp7 = 1; tmp7 <= tmp8; tmp7++)
      {
        _b = arrayGet(tmpMeta2,tmp7);
        {
          modelica_metatype _k;
...
modelica_metatype omc_UnorderedSet_merge(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fset1, modelica_metatype _set2)
{
  ...
  {
    modelica_metatype _b;
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set2, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
...
modelica_metatype omc_UnorderedSet_union(threadData_t *threadData, modelica_metatype _set1, modelica_metatype _set2)
{
  ...
  // _small_sz has no default value.
  // _small_set has no default value.
  _sz1 = omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set1, 3))));

  _sz2 = omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set2, 3))));
  ...
  if((_small_sz > ((modelica_integer) 0)))
  {
    {
      modelica_metatype _b;
      for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_small_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
      {
        _b = arrayGet(tmpMeta1,tmp5);
        {
          modelica_metatype _k;
...
void omc_UnorderedSet_dump(threadData_t *threadData, modelica_metatype _set, modelica_fnptr _stringFn)
{
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  fputs(omc_string_data(omc_UnorderedSet_toString(threadData, _set, ((modelica_fnptr) _stringFn), _OMC_LIT0)),stdout);
...
modelica_string omc_UnorderedSet_toString(threadData_t *threadData, modelica_metatype _set, modelica_fnptr _stringFn, modelica_string _delimiter)
{
  ...
  // _str has no default value.
  {
    ...
    while(1) {
      ...
      if (tmp4 == 0) {
        __omcQ_24tmpVar2 = (OMC_BOX_FIELD(_stringFn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_stringFn, 1))) (threadData, (OMC_BOX_FIELD(_stringFn, 2)), _k) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_stringFn, 1))) (threadData, _k);
  ...
  omc_string_store(&(_str), stringDelimitList(tmpMeta1, _delimiter));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _str;
  return omc_ret_;
}
...
void omc_UnorderedSet_rehash(threadData_t *threadData, modelica_metatype _set)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _old_buckets = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2)));
  // _new_buckets has no default value.
  // _bucket_count has no default value.
  // _hash has no default value.
  _hashfn = (OMC_BOX_FIELD(_set, 4));
  _bucket_count = omc_Util_nextPrime(threadData, (((modelica_integer) 2)) * (omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3))))));
...

  {
    ...
    for (tmpMeta2 = _old_buckets, tmp8 = arrayLength(tmpMeta2), tmp7 = 1; tmp7 <= tmp8; tmp7++)
    {
      _b = arrayGet(tmpMeta2,tmp7);
      {
        ...
        {
          _k = MMC_CAR(tmpMeta3);
          _hash = modelica_integer_mod(omc_unbox_integer((OMC_BOX_FIELD(_hashfn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, (OMC_BOX_FIELD(_hashfn, 2)), _k) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, _k)), _bucket_count);
  ...
  omc_Mutable_update(threadData, (OMC_BOX_FIELD(_set, 2)), _new_buckets);
  _return: OMC_LABEL_UNUSED
  return;
}
...
modelica_real omc_UnorderedSet_loadFactor(threadData_t *threadData, modelica_metatype _set)
{
  ...
  _load = (((modelica_real)omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3)))))) / tmp1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _load;
  return omc_ret_;
}
...
modelica_integer omc_UnorderedSet_bucketCount(threadData_t *threadData, modelica_metatype _set)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _count = arrayLength(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _count;
  return omc_ret_;
}
...
modelica_boolean omc_UnorderedSet_isEmpty(threadData_t *threadData, modelica_metatype _set)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _empty = (omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3)))) == ((modelica_integer) 0));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _empty;
  return omc_ret_;
}
...
modelica_integer omc_UnorderedSet_size(threadData_t *threadData, modelica_metatype _set)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _s = omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3))));
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _s;
  return omc_ret_;
}
...
modelica_metatype omc_UnorderedSet_splitOnTrue(threadData_t *threadData, modelica_metatype _set, modelica_fnptr _fn, modelica_metatype *out_falseSet)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _trueSet = omc_UnorderedSet_new(threadData, (OMC_BOX_FIELD(_set, 4)), (OMC_BOX_FIELD(_set, 5)), ((modelica_integer) 13));
  _falseSet = omc_UnorderedSet_new(threadData, (OMC_BOX_FIELD(_set, 4)), (OMC_BOX_FIELD(_set, 5)), ((modelica_integer) 13));
  {
    modelica_metatype _b;
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        modelica_metatype _k;
        ...
        {
          _k = MMC_CAR(tmpMeta2);
          omc_UnorderedSet_add(threadData, _k, (omc_unbox_boolean((OMC_BOX_FIELD(_fn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), _k) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, _k))?_trueSet:_falseSet));
        }
      }
    }
  }
  ...
  _falseSet = omc_UnorderedSet_new(threadData, (OMC_BOX_FIELD(_set, 4)), (OMC_BOX_FIELD(_set, 5)), ((modelica_integer) 13));
  {
    ...
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        ...
        {
          _k = MMC_CAR(tmpMeta2);
          if((!omc_unbox_boolean((OMC_BOX_FIELD(_fn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), _k) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, _k))))
          {
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  {
    ...
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        ...
        {
          _k = MMC_CAR(tmpMeta2);
          (OMC_BOX_FIELD(_fn, 2)) ? ((void(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), _k) : ((void(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, _k);
        }
      }
    }
  }
...
modelica_metatype omc_UnorderedSet_selfMap(threadData_t *threadData, modelica_metatype _set, modelica_fnptr _fn)
{
  ...
  OMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  _outSet = omc_UnorderedSet_new(threadData, (OMC_BOX_FIELD(_set, 4)), (OMC_BOX_FIELD(_set, 5)), ((modelica_integer) 13));
  {
    modelica_metatype _b;
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        ...
        {
          _k = MMC_CAR(tmpMeta2);
          omc_UnorderedSet_add(threadData, (OMC_BOX_FIELD(_fn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), _k) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, _k), _outSet);
        }
      }
    }
  }
  ...
  _result = _startValue;
  {
    ...
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        ...
        {
          _k = MMC_CAR(tmpMeta2);
          _result = (OMC_BOX_FIELD(_fn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, (OMC_BOX_FIELD(_fn, 2)), _k, _result) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_fn, 1))) (threadData, _k, _result);
        }
      }
    }
  }
...
modelica_metatype omc_UnorderedSet_toArray(threadData_t *threadData, modelica_metatype _set)
{
  ...
  _outArray = arrayCreateNoInit(omc_unbox_integer(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3)))), _dummy);
...
modelica_metatype omc_UnorderedSet_toList(threadData_t *threadData, modelica_metatype _set)
{
  ...
  {
    modelica_metatype _b;
    for (tmpMeta2 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp8 = arrayLength(tmpMeta2), tmp7 = 1; tmp7 <= tmp8; tmp7++)
    {
      _b = arrayGet(tmpMeta2,tmp7);
      {
        modelica_metatype _k;
...
modelica_boolean omc_UnorderedSet_isEqual(threadData_t *threadData, modelica_metatype _set1, modelica_metatype _set2)
{
  ...
  {
    modelica_metatype _b;
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set1, 2))), tmp6 = arrayLength(tmpMeta1), tmp5 = 1; tmp5 <= tmp6; tmp5++)
    {
      _b = arrayGet(tmpMeta1,tmp5);
      {
        modelica_metatype _k;
...
modelica_metatype omc_UnorderedSet_first(threadData_t *threadData, modelica_metatype _set)
{
  ...
  {
    modelica_metatype _b;
    for (tmpMeta1 = omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))), tmp4 = arrayLength(tmpMeta1), tmp3 = 1; tmp3 <= tmp4; tmp3++)
    {
...
void omc_UnorderedSet_addNew(threadData_t *threadData, modelica_metatype _key, modelica_metatype _set)
{
  ...
  _hashfn = (OMC_BOX_FIELD(_set, 4));
  // _hash has no default value.
  _hash = modelica_integer_mod(omc_unbox_integer((OMC_BOX_FIELD(_hashfn, 2)) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, (OMC_BOX_FIELD(_hashfn, 2)), _key) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (OMC_BOX_FIELD(_hashfn, 1))) (threadData, _key)), arrayLength(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2)))));
...
modelica_metatype omc_UnorderedSet_copy(threadData_t *threadData, modelica_metatype _set)
{
  ...
  tmpMeta1 = omc_mk_box5(3, &UnorderedSet_UNORDERED__SET__desc, omc_Mutable_create(threadData, arrayCopy(omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 2))))), omc_Mutable_create(threadData, omc_Mutable_access(threadData, (OMC_BOX_FIELD(_set, 3)))), (OMC_BOX_FIELD(_set, 4)), (OMC_BOX_FIELD(_set, 5)));
  _outSet = tmpMeta1;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _outSet;
  return omc_ret_;
...
modelica_metatype omc_UnorderedSet_new(threadData_t *threadData, modelica_fnptr _hash, modelica_fnptr _keyEq, modelica_integer _bucketCount)
{
  ...
  tmpMeta2 = omc_mk_box5(3, &UnorderedSet_UNORDERED__SET__desc, _buckets, omc_Mutable_create(threadData, omc_mk_integer(((modelica_integer) 0))), ((modelica_fnptr) _hash), ((modelica_fnptr) _keyEq));
  _set = tmpMeta2;
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _set;
  return omc_ret_;
