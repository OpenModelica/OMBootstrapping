    ...
    tmp4_1 = _inAttributeLst;
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 0: {
          ...
          tmp10 = stringAppend(_inString,_name);
          omc_string_store(&(_s), tmp10);

          tmp11 = stringAppend(_s,_OMC_LIT0);
          omc_string_store(&(_s), tmp11);
          tmp12 = stringAppend(_s,_v);
          tmp1 = tmp12;
          goto tmp3_done;
        }
        case 1: {
          ...
          _rest = tmpMeta14;
          /* Pattern matching succeeded */
          tmp17 = stringAppend(_inString,_name);
          omc_string_store(&(_s), tmp17);

          tmp18 = stringAppend(_s,_OMC_LIT0);
          omc_string_store(&(_s), tmp18);

          tmp19 = stringAppend(_s,_v);
          omc_string_store(&(_s), tmp19);

          tmp20 = stringAppend(_s,_OMC_LIT1);
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_makeAttr(threadData_t *threadData, modelica_metatype _l)
{
  ...
  // _s has no default value.
  omc_string_store(&(_res), omc_Graphviz_makeAttrReq(threadData, _l, _OMC_LIT2));

  tmp1 = stringAppend(_OMC_LIT3,_res);
  omc_string_store(&(_s), tmp1);

  tmp2 = stringAppend(_s,_OMC_LIT4);
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_makeNode(threadData_t *threadData, modelica_string _nm, modelica_metatype _attr)
{
  ...
  omc_string_store(&(_s), omc_Graphviz_makeAttr(threadData, _attr));

  tmp1 = stringAppend(_nm,_s);
  omc_string_store(&(_s_1), tmp1);

  tmp2 = stringAppend(_s_1,_OMC_LIT5);
  omc_string_store(&(_str), tmp2);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _str;
  return omc_ret_;
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_makeEdge(threadData_t *threadData, modelica_string _n1, modelica_string _n2)
{
  ...
  // _str has no default value.
  // _s has no default value.
  tmp1 = stringAppend(_n1,_OMC_LIT6);
  omc_string_store(&(_s), tmp1);

  tmp2 = stringAppend(_s,_n2);
  omc_string_store(&(_str), tmp2);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _str;
  return omc_ret_;
...
PROTECTED_FUNCTION_STATIC void omc_Graphviz_printEdge(threadData_t *threadData, modelica_string _n1, modelica_string _n2)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _str has no default value.
  omc_string_store(&(_str), omc_Graphviz_makeEdge(threadData, _n1, _n2));
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_nodename(threadData_t *threadData, modelica_string _str)
{
  ...
  omc_string_store(&(_is), intString(_i));

  tmp1 = stringAppend(_OMC_LIT8,_is);
  omc_string_store(&(_s), tmp1);
  _return: OMC_LABEL_UNUSED
  omc_ret_ = _s;
  return omc_ret_;
    ...
    tmp3_2 = _inChildren;
    {
      ...
      for (; tmp3 < 2; tmp3++) {
        ...
        case 1: {
          ...
          _parent = tmp3_1;
          /* Pattern matching succeeded */
          omc_string_store(&(_nm), omc_Graphviz_dumpNode(threadData, _node));
    ...
    tmp4_1 = _inStringLst;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          _s = tmpMeta6;
          /* Pattern matching succeeded */
          tmp8 = stringAppend(_inString,_s);
          tmp1 = tmp8;
          goto tmp3_done;
        }
        case 1: {
          ...
          _s2 = tmpMeta11;
          /* Pattern matching succeeded */
          tmp13 = stringAppend(_inString,_s1);
          omc_string_store(&(_s), tmp13);

          tmp14 = stringAppend(_s,_OMC_LIT9);
          omc_string_store(&(_s), tmp14);
          tmp15 = stringAppend(_s,_s2);
          tmp1 = tmp15;
          goto tmp3_done;
        }
        case 2: {
          ...
          _rest = tmpMeta17;
          /* Pattern matching succeeded */
          tmp18 = stringAppend(_inString,_s1);
          omc_string_store(&(_s), tmp18);

          tmp19 = stringAppend(_s,_OMC_LIT9);
          omc_string_store(&(_s), tmp19);
          /* Tail recursive call */
          _inStringLst = _rest;
          _inString = _s;
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_makeLabel(threadData_t *threadData, modelica_metatype _sl)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _s2 has no default value.
  // _s0 has no default value.
  // _s1 has no default value.
  omc_string_store(&(_s0), omc_Graphviz_makeLabelReq(threadData, _sl, _OMC_LIT2));

  tmp1 = stringAppend(_OMC_LIT10,_s0);
  omc_string_store(&(_s1), tmp1);

  tmp2 = stringAppend(_s1,_OMC_LIT10);
...
PROTECTED_FUNCTION_STATIC modelica_string omc_Graphviz_dumpNode(threadData_t *threadData, modelica_metatype _inNode)
{
  ...
  { /* match expression */
    ...
    tmp4_1 = _inNode;
    {
      ...
      int tmp5;
      // _nm has no default value.
      // _typlbl has no default value.
      // _out has no default value.
      // _typ has no default value.
      // _lblstr has no default value.
      // _newattr has no default value.
      // _attr has no default value.
      // _children has no default value.
      // _lbl_1 has no default value.
      // _lbl has no default value.
      tmp4 = 0;
      for (; tmp4 < 2; tmp4++) {
        switch (MMC_SWITCH_CAST(tmp4)) {
        case 0: {
          ...
          _children = tmpMeta8;
          /* Pattern matching succeeded */
          omc_string_store(&(_nm), omc_Graphviz_nodename(threadData, _typ));

          tmpMeta9 = mmc_mk_cons(_typ, MMC_REFSTRUCTLIT(mmc_nil));
          omc_string_store(&(_typlbl), omc_Graphviz_makeLabel(threadData, tmpMeta9));

          tmpMeta11 = omc_mk_box3(3, &Graphviz_Attribute_ATTR__desc, _OMC_LIT11, _typlbl);
          tmpMeta10 = mmc_mk_cons(tmpMeta11, _attr);
          _newattr = tmpMeta10;

          omc_string_store(&(_out), omc_Graphviz_makeNode(threadData, _nm, _newattr));

          fputs(omc_string_data(_out),stdout);
        ...
        case 1: {
          ...
          omc_string_store(&(_lblstr), omc_Graphviz_makeLabel(threadData, _lbl_1));

          tmpMeta18 = omc_mk_box3(3, &Graphviz_Attribute_ATTR__desc, _OMC_LIT11, _lblstr);
