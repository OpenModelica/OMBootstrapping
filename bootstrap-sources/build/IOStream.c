...
modelica_boolean omc_IOStream_empty(threadData_t *threadData, modelica_metatype _inStream)
{
  ...
  _data = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_inStream), 4)));
  { /* match expression */
    modelica_metatype tmp4_1;
    tmp4_1 = _data;
    {
      ...
      for (; tmp4 < 1; tmp4++) {
        ...
        case 0: {
          ...
          /* Pattern matching succeeded */
          tmp1 = listEmpty((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_data), 2))));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
...
modelica_metatype omc_IOStream_appendListReverse(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fs, modelica_metatype _data)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  _s = __omcQ_24in_5Fs;
  _s_data = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_s), 4)));
  { /* match expression */
    modelica_metatype tmp3_1;
    tmp3_1 = _s_data;
    {
      int tmp3;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            for (tmpMeta4 = _data; !listEmpty(tmpMeta4); tmpMeta4=MMC_CDR(tmpMeta4))
            {
              ...
              omc_IOStreamExt_appendFile(threadData, mmc_unbox_integer((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_s_data), 2)))), _str);
            }
          }
          goto tmp2_done;
        }
        case 4: {
          ...
          ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta6))[2] = listAppend(_data, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_s_data), 2))));
          _s_data = tmpMeta6;
        ...
        case 5: {
          ...
          /* Pattern matching succeeded */
          {
            ...
            for (tmpMeta8 = _data; !listEmpty(tmpMeta8); tmpMeta8=MMC_CDR(tmpMeta8))
            {
              ...
              omc_IOStreamExt_appendBuffer(threadData, mmc_unbox_integer((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_s_data), 2)))), _str);
            }
          }
          goto tmp2_done;
        }
